...
def mytest():
    tmp = DesignFile()
    print('read_design_file:'+str(tmp.read_design_file(r'UnitDesign\design.md')))
    print("get_all_design_unit:"+str(tmp.get_all_design_unit()))

    tmp2 = DesignFile(r'UnitDesign\design.md')
    print("init函数读文件get_all_design_unit:"+str(tmp2.get_all_design_unit()))
    tmp2.gen_design_md()
