...
> replace_application_service(app_service_id, application_service=application_service)
...
application_service = agilicus_api.ApplicationService() # ApplicationService |  (optional)
    ...
    try:
        # Create or update an Application Service.
        api_instance.replace_application_service(app_service_id, application_service=application_service)
    except ApiException as e:
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**204** | Application Service updated |  -  |
**404** | Application Service does not exist. |  -  |
