...
class Mac(BaseMac):
    ...
    def create_or_update_mac(self,
        ...
        r = self._session.put(url=self._base_url, json=mac_data_input.dict(), params=params)
        validate_201(r=r)
...
class AsyncMac(BaseMac):
    ...
    async def create_or_update_mac(self,
                                   active: bool,
                                   mac_address: str,
                                   switch_ip: str,
                                   switch_serial_number: str,
        ...
        mac_data_input = MacModel(active=active, mac_address=mac_address, switch_ip=switch_ip,
                                  ...
                                  vlan_id=vlan_id)
        params = {"update_time": update_time}
        r = await self._session.put(url=self._base_url, json=mac_data_input.dict(), params=params)
        validate_201(r=r)
        return MacInDB(**r.json())
