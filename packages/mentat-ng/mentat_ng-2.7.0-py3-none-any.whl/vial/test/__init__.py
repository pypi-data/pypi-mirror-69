...
class VialTestCase(unittest.TestCase):
    ...
    def assertGetURL(self, url, status_code = 200, content_checks = None, print_response = False):  # pylint: disable=locally-disabled,invalid-name
        """
    ...
    def assertPostURL(self, url, data, status_code = 200, content_checks = None, print_response = False):  # pylint: disable=locally-disabled,invalid-name
        """
