...
class Processor(object):
    ...
    def load_changes(self):
        ...
        # TODO add another method to parse diff from `git diff base...head`
        # Then in stickler compare and log if there are differences.
        # This may require updating the repo to contain 'fixture commits'
        # so that I have historical data to generate diffs to run tests on
        # later.
