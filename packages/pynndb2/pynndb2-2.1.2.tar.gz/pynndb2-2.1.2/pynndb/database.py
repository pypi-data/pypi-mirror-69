...
from .serialiser import SerialiserType
from .decorators import wrap_reader_yield, wrap_reader
...
class Database(UserDict):
    ...
    def table(self, table_name: str, codec: SerialiserType=SerialiserType.NONE, txn: Optional[TXN]=None) -> Table:
        """
        ...
        if not self.data[table_name].isopen:
            self.data[table_name].open(codec=codec, txn=txn)
