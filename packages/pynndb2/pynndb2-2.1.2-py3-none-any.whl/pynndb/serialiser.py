...
from .doc import Doc
from .exceptions import InvalidSerialiser
...
class Serialiser:
    ...
    def __init__(self, codec: Optional[SerialiserType]=SerialiserType.NONE, txn: TXN=None):
        ...
        codec - module that will supply "dumps" and "loads" methods for serialisation and deserialisation
        """
        ...
        if codec == SerialiserType.UJSON:
            ...
            raise Exception('No serialisers available ["json", "orjson"]')  # pragma: no cover
        #
        self._codec = codec
        #
