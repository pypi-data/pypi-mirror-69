...
with open(path.join(here, 'sunnyportal', '__init__.py'), encoding='utf-8') as f:
    lines = f.readlines()
    for l in lines:
...
setup(
    ...
    keywords='sma sunny portal solar pv python client api',
    ...
    install_requires=['pandas', 'certifi'],
    ...
    # MANIFEST.in as well.
    package_data={
        'sunnyportal-py': ['LICENSE', 'README.md'],
    },
)
