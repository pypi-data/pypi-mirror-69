...
class SubscriptionProps():
    def __init__(self, *, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None) -> None:
...
class UrlSubscriptionProps(SubscriptionProps):
    def __init__(self, *, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None, protocol: typing.Optional[aws_cdk.aws_sns.SubscriptionProtocol]=None, raw_message_delivery: typing.Optional[bool]=None) -> None:
...
class EmailSubscriptionProps(SubscriptionProps):
    def __init__(self, *, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None, json: typing.Optional[bool]=None) -> None:
...
class SqsSubscriptionProps(SubscriptionProps):
    def __init__(self, *, filter_policy: typing.Optional[typing.Mapping[str, aws_cdk.aws_sns.SubscriptionFilter]]=None, raw_message_delivery: typing.Optional[bool]=None) -> None:
