...
def persist_lines_job(project_id, dataset_id, lines=None, truncate=False, validate_records=True):
    ...
    for line in lines:
        ...
        if isinstance(msg, singer.RecordMessage):
            ...
            rows[msg.stream][current_schema_key].write(dat)
            ...
            if key not in schemas:
                ...
                rows[table][key] = TemporaryFile(mode='w+b')
    ...
    for table in rows.keys():
        ...
        for schema_key in tables_schemas.keys():
            ...
            load_config.schema = schemas[schema_key]
            ...
            file_ref = tables_schemas[schema_key]
            file_ref.seek(0)
