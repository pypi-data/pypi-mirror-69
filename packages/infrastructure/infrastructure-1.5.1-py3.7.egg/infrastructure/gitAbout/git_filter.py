...
# @Last Modified time: 2020-05-28 20:25:34
...
class GitFilter(object):
	...
	def __init__(self,serviceRepoDir="",service_name=""):
		if serviceRepoDir:
			...
			self.repoDir = '/home/maoyongfan10020/jc/repo'
			self.serviceRepoDir = '/home/maoyongfan10020/jc/repo/{service_name}'.format(service_name)
	...
	def filter_jarName(self,coverageLog="",alreadyRecord=""):
		"""
								...
								if sub_name:
									if coverageLog:
										record = coverageLog(data=
										{
											...
											"message": sub_name,
											"remark": "{recordId}次覆盖率统计{service_name}".format(recordId=alreadyRecord.recordId,
