...
.. code:: python
  ...
  return was.Map (tasks, "db", "api", None) # None for no return
...
.. code:: python
  ...
  def bench_sp (was):
    ...
    return was.Map (ts, 'result', 'record_count__cnt')
    # JSON response,
...
.. code:: python
  ...
  return was.Map ('210 Something', ts, 'result', 'record_count__cnt')
