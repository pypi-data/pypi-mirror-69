...
class _listcal:
    ...
    __schema = {'vis': {'type': 'cReqPath', 'coerce': _coerce.expand_path}, 'caltable': {'type': 'cReqPath', 'coerce': _coerce.expand_path}, 'field': {'type': 'cStr'}, 'antenna': {'type': 'cStr'}, 'spw': {'type': 'cStr'}, 'listfile': {'type': 'cStr'}, 'pagerows': {'type': 'cInt'}}
    ...
    def tget(self,file=None):
        ...
        filename = None
        if file is None:
            if os.path.isfile("listcal.last"):
                filename = "listcal.last"
