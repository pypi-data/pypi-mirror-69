...
class AbstractRunner(ABC):
    def __init__(self, starting_date = None, running_date = None, drop_token=None, dropbox_backup = True, underlying = None, freqly_return_pkl_filename_suffix='freqly_candels.pkl',aggregated_pkl_file_name='freqly_to_mix.pkl', aggregated_pkl_mapping_file_name = 'freqly_to_mix_mapping.pkl', list_pkl_file_name = 'my_list.pkl', local_root_directory='../data/', user = 'napoleon', add_turn_over = False, skipping_size=200, recompute_all = True, db_path_suffix=None):
        super().__init__()
