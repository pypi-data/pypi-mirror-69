        ...
        for index in range(len(df)):
            ...
            if existing_paper_id == 0:
                ...
                if 'id' in response.content:
                    ...
                    paper_statements = self.client.statements.get_by_subject(subject_id=paper_id).content
            ...
            # paper exists already, so add a contribution       
                ...
                paper_statements = self.client.statements.get_by_subject(subject_id=existing_paper_id).content
