...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', 'v2.2.0-alpha.1590670433+ga1e02ab'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq v2.2.0-alpha.1590670433+ga1e02ab`
                """)
            else:
                raise
