...
from redis3.sentinel import (Sentinel, SentinelConnectionPool,
                             MasterNotFoundError, SlaveNotFoundError)
from redis3._compat import next
import redis3.sentinel
...
def cluster(request):
    def teardown():
        redis3.sentinel.Redis = saved_Redis
    cluster = SentinelTestCluster()
    saved_Redis = redis3.sentinel.Redis
    redis3.sentinel.Redis = cluster.client
