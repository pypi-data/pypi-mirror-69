...
setup(
  name = 'test_code1996',         # How you named your package folder (MyLib)
  packages = ['test_code1996'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code1996/archive/v3.0.zip',
