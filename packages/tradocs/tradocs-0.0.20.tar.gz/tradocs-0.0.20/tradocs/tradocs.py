...
def root():
    ...
    workTree = [n.a_blob.path for n in allModified if n.a_blob.path.split('/')[0] == '_'.join(sourceLang.split('-')).lower()] + [repo.untracked_files for n[1:] in os.listdir(sourceDir)] 
