...
- id (string; optional): The ID used to identify this component in Dash callbacks."""
    @_explicitize_args
    def __init__(self, children=None, imperial=Component.UNDEFINED, metric=Component.UNDEFINED, updateWhenIdle=Component.UNDEFINED, maxWidth=Component.UNDEFINED, className=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'imperial', 'metric', 'updateWhenIdle', 'maxWidth', 'className', 'id']
        self._type = 'ScaleControl'
        self._namespace = 'dash_leaflet'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'imperial', 'metric', 'updateWhenIdle', 'maxWidth', 'className', 'id']
