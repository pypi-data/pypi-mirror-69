...
- transparent (boolean; optional): If true, the WMS service will return images with transparency.
...
- uppercase (boolean; optional): If true, WMS request parameter keys will be uppercase.
...
- attribution (string; optional): The attribution string for the component (dynamic)"""
    @_explicitize_args
    def __init__(self, children=None, url=Component.REQUIRED, layers=Component.REQUIRED, styles=Component.UNDEFINED, format=Component.UNDEFINED, transparent=Component.UNDEFINED, version=Component.UNDEFINED, crs=Component.UNDEFINED, uppercase=Component.UNDEFINED, minZoom=Component.UNDEFINED, maxZoom=Component.UNDEFINED, subdomains=Component.UNDEFINED, errorTileUrl=Component.UNDEFINED, zoomOffset=Component.UNDEFINED, tms=Component.UNDEFINED, zoomReverse=Component.UNDEFINED, detectRetina=Component.UNDEFINED, crossOrigin=Component.UNDEFINED, tileSize=Component.UNDEFINED, opacity=Component.UNDEFINED, updateWhenIdle=Component.UNDEFINED, updateWhenZooming=Component.UNDEFINED, updateInterval=Component.UNDEFINED, zIndex=Component.UNDEFINED, bounds=Component.UNDEFINED, minNativeZoom=Component.UNDEFINED, maxNativeZoom=Component.UNDEFINED, noWrap=Component.UNDEFINED, className=Component.UNDEFINED, keepBuffer=Component.UNDEFINED, id=Component.UNDEFINED, pane=Component.UNDEFINED, attribution=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'url', 'layers', 'styles', 'format', 'transparent', 'version', 'crs', 'uppercase', 'minZoom', 'maxZoom', 'subdomains', 'errorTileUrl', 'zoomOffset', 'tms', 'zoomReverse', 'detectRetina', 'crossOrigin', 'tileSize', 'opacity', 'updateWhenIdle', 'updateWhenZooming', 'updateInterval', 'zIndex', 'bounds', 'minNativeZoom', 'maxNativeZoom', 'noWrap', 'className', 'keepBuffer', 'id', 'pane', 'attribution']
        self._type = 'WMSTileLayer'
        self._namespace = 'dash_leaflet'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'url', 'layers', 'styles', 'format', 'transparent', 'version', 'crs', 'uppercase', 'minZoom', 'maxZoom', 'subdomains', 'errorTileUrl', 'zoomOffset', 'tms', 'zoomReverse', 'detectRetina', 'crossOrigin', 'tileSize', 'opacity', 'updateWhenIdle', 'updateWhenZooming', 'updateInterval', 'zIndex', 'bounds', 'minNativeZoom', 'maxNativeZoom', 'noWrap', 'className', 'keepBuffer', 'id', 'pane', 'attribution']
