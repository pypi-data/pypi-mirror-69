...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v2.3.0-alpha.1590508712+g0f4eeaa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v2.3.0-alpha.1590508712+g0f4eeaa`
                """)
            else:
                raise
