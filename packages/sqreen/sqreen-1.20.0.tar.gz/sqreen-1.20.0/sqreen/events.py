    ...
    def to_trace(self):
        ...
        for entry in event_payload.get("observed", {}).get("sqreen_exceptions", []):
            signal = Signal(
                ...
                payload_schema="exception/2020-01-01T00:00:00.000Z",
                payload={
                    "klass": entry["klass"],
        ...
        for entry in event_payload.get("observed", {}).get("sdk", []):
            ...
            data.append(Signal(
                ...
                payload_schema="track_event/2020-01-01T00:00:00.000Z",
                payload=payload,
            ))
        ...
        context["response"] = dict(event_payload.get("response", {}))
