...
from .__config__ import __apiUrl__, __messageService__, __version__


class Framework:

    def __init__(self, app_id: str = "", app_secret: str = "", callback: any = None):
        ...
        Message(__messageService__, self.auth_mac, app_id, app_secret, callback).start()
