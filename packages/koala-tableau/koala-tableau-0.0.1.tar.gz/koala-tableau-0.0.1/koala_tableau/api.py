...
def get_workbooks(site_id: str, api_token: str):
    res = requests.get(f"{os.environ['TABLEAU_URL']}/api/{os.environ['TABLEAU_API_VERSION']}/sites/{site_id}/workbooks",
...
def get_views(site_id: str, workbook_id: str, api_token: str):
    res = requests.get(f"{os.environ['TABLEAU_URL']}/api/{os.environ['TABLEAU_API_VERSION']}/sites/{site_id}/"
