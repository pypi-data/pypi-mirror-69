...
setup(
  name = 'test_code1998',         # How you named your package folder (MyLib)
  packages = ['test_code1998'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code1998/archive/v5.0.zip',
