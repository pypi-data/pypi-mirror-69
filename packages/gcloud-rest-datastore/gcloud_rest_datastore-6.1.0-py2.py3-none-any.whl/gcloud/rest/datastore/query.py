...
class Query(BaseQuery):
    ...
    def __init__(self, kind      = '', query_filter         = None,
                 order                      = None, start_cursor      = '',
                 end_cursor      = '', offset                = None,
                 limit                = None,
                 projection                   = None,
                 distinct_on            = None)        :
        self.kind = kind
...
class GQLQuery(BaseQuery):
    ...
    def __init__(self, query_string     , allow_literals       = True,
                 named_bindings                 = None,
