...
def ds_cnn_cifar10(input_shape,
                   classes=10,
                   weights=None,
    ...
    if weights == 'cifar10':
        ...
        if quant_params != (4, 4, 8):
            raise ValueError(
                "If 'weights' is 'cifar10', quantization parameters "
        ...
        if input_shape[0] != 32 or input_shape[1] != 32:
            print(
                "If 'weights' is 'cifar10', weights trained for input (32, 32) "
                "will be used")
    ...
    # Load weights
    if weights == 'cifar10':
        model_name = (f'ds_cnn_cifar10_wq{weight_quantization}'
