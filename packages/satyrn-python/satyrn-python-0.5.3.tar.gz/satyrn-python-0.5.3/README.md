...
![](satyrn-python/media/cover.png?raw=true)
...
* `[filename].satx`
    - This will run a .satx file. It's just a reformatted version of the normal Satyrn input. [This test file](satyrn-python/examples/syntax_example.satx) shows the basic syntax rules.
