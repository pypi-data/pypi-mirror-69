...
def determine_feature_type(series: pd.Series, counts: dict,
    ...
    try:
        ...
        # elif is_date(series):
        #     var_type = FeatureType.TYPE_DATE
        # elif is_url(series, counts):
        #     var_type = FeatureType.TYPE_URL
        # elif is_path(series, counts) and sys.version_info[1] > 5:
        #     var_type = FeatureType.TYPE_PATH
        else:
