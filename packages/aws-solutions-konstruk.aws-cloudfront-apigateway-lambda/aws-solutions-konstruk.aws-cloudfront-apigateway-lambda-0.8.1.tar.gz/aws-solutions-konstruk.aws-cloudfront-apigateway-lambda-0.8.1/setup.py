...
kwargs = json.loads("""
{
    ...
    "packages": [
        "aws_solutions_konstruk.aws_cloudfront_apigateway_lambda",
        "aws_solutions_konstruk.aws_cloudfront_apigateway_lambda._jsii"
    ],
    "package_data": {
        "aws_solutions_konstruk.aws_cloudfront_apigateway_lambda._jsii": [
            "aws-cloudfront-apigateway-lambda@0.8.1.jsii.tgz"
        ],
        "aws_solutions_konstruk.aws_cloudfront_apigateway_lambda": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-konstruk.aws-cloudfront-apigateway>=0.8.1, <0.9.0",
