...
class PickableRecordset:
    ...
    def __setstate__(self, state):
        ...
        if context[_CURRENT_ENVIRONMENT] or context[_FORCED_ENVIRONMENT]:
            # Force browsing the instance so that you don't have to use
            # CURRENT_ENVIRONMENT in weird places.  You're unpickling this
            # object in such a context for a reason.
            self.instance
