...
@click.option(
    "-l",
    "--label",
    help=_("Custom the name of the task (used to name the log file)"),
...
@click.option(
    ...
    "--settings",
    default=".env",
    help=_("Environment file containing settings"),
...
def scan_metadata_processor(
    ...
    logger.info(
        _("Main CLI completed after {:5.2f}s.").format(default_timer() - START_TIME)
    )
