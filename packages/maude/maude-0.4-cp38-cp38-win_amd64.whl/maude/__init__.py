...
class Term(object):
    ...
    def get_variants(self, *args):
        ...
        """
        return _maude.Term_get_variants(self, *args)
...
class Module(object):
    ...
    def unify(self, problem):
        ...
        """
        return _maude.Module_unify(self, problem)

    def variant_unify(self, *args):
        r"""
        ...
        :return: An object to iterate through unifiers.
        """
        return _maude.Module_variant_unify(self, *args)
...
class VariantUnifierSearch(object):
    r"""An iterator through unifiers for variant unification."""
