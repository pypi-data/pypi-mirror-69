...
setup(
    ...
    url = 'https://github.com/deniswerth/ODEN',   # Provide either the link to your github or to your website
    download_url = 'https://github.com/deniswerth/ODEN',    # I explain this later on
