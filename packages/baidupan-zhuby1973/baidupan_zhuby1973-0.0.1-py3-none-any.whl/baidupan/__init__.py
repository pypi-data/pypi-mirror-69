...
class BaiDuPan(object):
    def __init__(self):
        ...
        self.session.cookies['BDUSS'] = 'JTY0hsVVp5NXh1c2lHUHFickVKRVpXUlBua0taLVYyWEFCS0Ixb2podWNnYWxlRVFBQUFBJCQAAAAAAAAAAAEAAAAyEFm5wNa527XEa3VrdTYwOQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAJz0gV6c9IFefm'
        self.session.cookies['STOKEN'] = '9ca72980e7ecb1946ac3cbd303ec16fae918b07afde9a726403808377df391a3'
        self.headers = {
            'Host': 'pan.baidu.com',
