...
setup(
  name = 'test_code2006',         # How you named your package folder (MyLib)
  packages = ['test_code2006'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code2006/archive/v13.0.zip',
