...
from DKCloudCommand.modules.DKCloudAPI import DKReturnCode  # noqa: E402
...
class Backend(object):
    ...
    def __init__(
            self, only_check_version: bool = False, current_command: Optional[str] = None
    ) -> None:
        self.cfg = None
        self.dki = None
...
@click.pass_obj
def kitchen_config(
        backend: Backend, kitchen: Optional[str], add: Optional[str], get: Optional[Tuple[str, ...]],
        unset: Optional[Tuple[str, ...]], listall: bool
) -> None:
    """
...
@click.pass_obj
def kitchen_merge(
        backend: Backend, source_kitchen: Optional[str], target_kitchen: str, yes: bool
) -> None:
    """
...
@click.pass_obj
def recipe_get(
        backend: Backend, recipe: Optional[str], delete_local: bool, overwrite: bool, yes: bool
) -> None:
    """
...
@click.pass_obj
def recipe_compile(
        backend: Backend, kitchen: Optional[str], recipe: Optional[str], variation: str
) -> None:
    """
...
@click.pass_obj
def file_merge(
        backend: Backend, source_kitchen: Optional[str], target_kitchen: str, filepath: str
) -> None:
    """
...
@click.pass_obj
def file_update(
        backend: Backend, kitchen: Optional[str], recipe: Optional[str], message: str,
        filepaths: Tuple[str, ...]
) -> None:
    """
...
@click.pass_obj
def order_run(
        backend: Backend, kitchen: Optional[str], recipe: Optional[str], variation: str, node: Optional[str],
        yes: bool, params: Optional[str]
) -> None:
    """
...
@click.pass_obj
def orderrun_detail(
        backend: Backend, kitchen: Optional[str], summary: bool, nodestatus: bool, runstatus: bool,
        full_log: bool, log: bool, log_threshold: str, timing: bool, test: bool, all_things: bool,
        order_id: Optional[str], order_run_id: Optional[str], disp_order_id: bool, disp_orderrun_id: bool
) -> None:
    """
...
@click.pass_obj
def order_list(
        backend: Backend, kitchen: Optional[str], order_count: int, order_run_count: int, start: int,
        recipe: Optional[str]
) -> None:
    """
...
@click.pass_obj
def secret_list(
        backend: Backend, path: Optional[str], global_secrets: bool, kitchen: Optional[str]
) -> None:
    """
    List Secrets
