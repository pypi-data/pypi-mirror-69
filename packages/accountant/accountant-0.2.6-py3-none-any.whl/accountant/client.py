...
class Accountant:
    ...
    def __init__(self, bank_account):
        ...
        self.ledger = LedgerClient(ledger_host="http://internal-prod-internal-loadbalancer-874786328.ap-southeast-1.elb.amazonaws.com/")
    ...
    def get_book_balances(self, currency: str, metadata_filter: dict = {}):
        ...
        return {'currency': currency,
                'blocked_balance_deposit': float(blocked_deposit_balance.get(currency, 0)),
                'blocked_balance_withdraw': float(blocked_withdraw_balance.get(currency, 0)),
                'main_balance': float(main_balance.get(currency, 0))}
    ...
    def create_book(account_id: str):
        log.info("---------New_ledger-------------")
        ledger = LedgerClient(ledger_host="http://internal-prod-internal-loadbalancer-874786328.ap-southeast-1.elb.amazonaws.com/")
