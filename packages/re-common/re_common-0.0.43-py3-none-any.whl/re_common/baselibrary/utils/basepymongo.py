...
class BasePyMongo(object):
    ...
    def insert_many(self, lists: List[dict]):
        ...
        """
        list_result = self.col.insert_many(lists)
        return list_result

    def get_insert_many_ids(self, list_result: InsertManyResult):
