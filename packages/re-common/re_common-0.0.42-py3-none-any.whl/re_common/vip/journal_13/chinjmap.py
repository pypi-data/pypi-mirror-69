...
hdrs = {"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36",
        "Referer": "http://www.chinjmap.com/ch/reader/issue_list.aspx",
        }

Parent = parent.Parent()

class Chinjmap(object):

    def __init__(self):
        self.journal = '中国现代应用药学'
        self.base_url = "http://www.chinjmap.com/ch/reader/"
        self.ero = 0
        self.suc = 0
        self.cnt = 0
        self.all_num = 0
    ...
    def getpdf(self, years, num, pdfRoot):
        ...
        url  = "http://www.chinjmap.com/ch/reader/issue_list.aspx?year_id={}&quarter_id={}".format(years,num)
        print(url)
        try:
