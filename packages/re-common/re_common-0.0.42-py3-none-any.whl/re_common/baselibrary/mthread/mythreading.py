...
class ThreadPoolManger(object):
    ...
    def add_super_thread(self, func, thread_name, *args, **kwargs):
        """
        添加一个线程，该线程直接由原生线程控制，
        :param func:
        :param thread_name:
    ...
    def set_add_especial_thread(self, func, threadname, *args, **kwargs):
        """
        添加特殊的线程
        :return:
        """
        # 得到一个线程对象
        thread = self.add_super_thread(func, threadname, *args, **kwargs)
