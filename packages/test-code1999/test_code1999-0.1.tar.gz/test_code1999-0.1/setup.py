...
setup(
  name = 'test_code1999',         # How you named your package folder (MyLib)
  packages = ['test_code1999'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code1999/archive/v6.0.zip',
