...
setup(
  ...
  author_email = 'adamalonil+ScrapeCanvas@gmail.com',      # Type in your E-Mail
  url = 'https://github.com/adamalon/ScrapeCanvas',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/adamalon/ScrapeCanvas/archive/v1.3.tar.gz',    # I explain this later on
