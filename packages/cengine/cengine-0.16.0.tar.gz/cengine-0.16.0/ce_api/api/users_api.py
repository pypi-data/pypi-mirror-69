...
class UsersApi(object):
    ...
    def update_loggedin_user_api_v1_users_put(self, **kwargs):  # noqa: E501
        """Update Loggedin User  # noqa: E501

        Update own user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_loggedin_user_api_v1_users_put(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param BodyUpdateLoggedinUserApiV1UsersPut body:
        :return: User
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_loggedin_user_api_v1_users_put_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.update_loggedin_user_api_v1_users_put_with_http_info(**kwargs)  # noqa: E501
            return data

    def update_loggedin_user_api_v1_users_put_with_http_info(self, **kwargs):  # noqa: E501
        """Update Loggedin User  # noqa: E501

        Update own user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_loggedin_user_api_v1_users_put_with_http_info(async_req=True)
        >>> result = thread.get()
