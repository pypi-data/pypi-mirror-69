...
async def event_message(client: fortnitepy.Client, message: fortnitepy.PartyMessage):
    ...
    elif content == "!What do you think about joseph":
        try:
            await message.reply("Kus um joseph")
        except:
             await message.reply('Something wen\'t wrong, try to restart with "!restart"')

    elif content == "!What do you think about rami":
        try:
            await message.reply("Rami is the best fortnite player out there, He made me!")
        except:
             await message.reply('Something wen\'t wrong, try to restart with "!restart"')

    elif content == "!Who are you?":
        try:
            await message.reply("I am a Fortnite bot created by Rami Janini, Instagram: JaniniRami_")
        except:
             await message.reply('Something wen\'t wrong, try to restart with "!restart"')

    elif content == "!What do you think about motasem":
        try:
            await message.reply("Motasem is good")
        except:
             await message.reply('Something wen\'t wrong, try to restart with "!restart"')

    elif content == "!What do you think about sanad":
        try:
            await message.reply("Sanad is good")
        except:
             await message.reply('Something wen\'t wrong, try to restart with "!restart"')
            ...
            async with aiohttp.ClientSession() as session:
                ...
                if new_cosmetics.status == 200:
                    ...
                    if len(new_skins) == 0:
                        ...
                        await message.reply(f'I will now show you {len(new_skins)} new skins')
    ...
    await message.reply('If you need any help contact @janinirami')
