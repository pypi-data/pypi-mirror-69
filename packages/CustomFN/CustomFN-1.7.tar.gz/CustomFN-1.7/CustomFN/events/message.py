...
async def event_message(client: fortnitepy.Client, message: fortnitepy.PartyMessage):
    ...
    elif content == "!info" or content == "!about":
        try:
            await message.reply('I am a Fornite bot created by @janinirami_')
        except:
            await message.reply('Something wen\'t wrong, try to restart with "!restart"')

    elif content == "!sanad" or content == "!motasem:
        try:
            await message.reply('He is a very good person')
        except:
            await message.reply('Something wen\'t wrong, try to restart with "!restart"')
