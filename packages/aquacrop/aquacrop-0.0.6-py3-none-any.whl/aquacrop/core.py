...
class AquaCropModel:
    ...
    def step(self,num_steps=1,till_termination=False):
        ...
        if till_termination==True:
            ...
            while self.ClockStruct.ModelTermination == False:
                ...
                self.ClockStruct,self.InitCond,self.Outputs = self.perform_timestep()
        else:
    ...
    def perform_timestep(self):
        ...
        #%% Get model solution %%
        NewCond,Outputs = solution(self.InitCond,self.ClockStruct,weather_step,self.Outputs,self.Farmer)

        #%% Check model termination %%
        ClockStruct = check_model_termination(self.ClockStruct,NewCond)

        #%% Update time step %%
        ClockStruct, InitCond,Outputs = update_time(ClockStruct,NewCond,Outputs,self.weather)
