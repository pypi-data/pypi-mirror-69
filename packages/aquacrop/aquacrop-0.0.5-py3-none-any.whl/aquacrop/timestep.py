...
def solution(InitCond,ClockStruct,weather_step,Outputs,Farmer):
    ...
    *Returns:*
    ...
    # 9. Check germination
    NewCond = germination(NewCond,Soil.zGerm,Soil.Profile,Crop,GDD,GrowingSeason)
    ...
    # 19. Root zone water
    Wr,_Dr,_TAW,_thRZ = root_zone_water(Soil.Profile,float(NewCond.Zroot),NewCond.th,Soil.zTop,float(Crop.Zmin),Crop.Aer)
...
# Cell
def reset_initial_conditions(ClockStruct,InitCond,weather):
...
# Cell
def update_time(ClockStruct,InitCond,Outputs,weather):
    """
    ...
    if ClockStruct.ModelTermination == False:
        ...
        and ((ClockStruct.SimOffSeason=='N')):
            ...
            if ClockStruct.SeasonCounter < ClockStruct.nSeasons-1:
                ...
                InitCond =  reset_initial_conditions(ClockStruct,InitCond,weather)
