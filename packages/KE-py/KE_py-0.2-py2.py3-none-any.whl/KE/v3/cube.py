...
class Cube(Base):
    ...
    def segments(self, start_time=None, end_time=None, offset=0, size=20, mp_values=''):
    ...
    def clone(self):
        ...
        """
        params = {'cubeName': self.name}
        body = {'projectName': self.project_name}
        json_obj = self._client.fetch_json('/cubes/', params=params, body=body)
        cube_json = json_obj['data']['cubes'][0]
