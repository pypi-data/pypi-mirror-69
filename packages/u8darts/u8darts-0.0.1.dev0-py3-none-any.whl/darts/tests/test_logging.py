...
class LoggingTestCase(unittest.TestCase):
    ...
    def test_timeseries_constructor_error_log(self):
        ...
        lc.check(
            ('darts.timeseries', 'ERROR', 'ValueError: Series must have at least three values.')
        )
    ...
    def test_timeseries_split_error_log(self):
        ...
        lc.check(
            ('darts.timeseries', 'ERROR', 'ValueError: Timestamp must be between 2000-01-01 00:00:00 and 2000-01-03 00:00:00')
        )
