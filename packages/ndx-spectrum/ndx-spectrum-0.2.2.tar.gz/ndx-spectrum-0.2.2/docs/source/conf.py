...
# -*- coding: utf-8 -*-
#
# ndx-spectrum documentation build configuration file, created by
# sphinx-quickstart on Fri Jun 14 15:35:45 2019.
#
...
htmlhelp_basename = 'ndx-spectrumdoc'
...
latex_documents = [
    (master_doc, 'ndx-spectrum.tex', 'ndx-spectrum Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-spectrum', 'ndx-spectrum Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-spectrum', 'ndx-spectrum Documentation',
     author, 'ndx-spectrum', 'One line description of project.',
     'Miscellaneous'),
]
