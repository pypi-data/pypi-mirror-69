...
from packaging_tutorial.RasaWSHH import version
from RasaWSHH.cli import (
    scaffold,
    run,
    train,
    interactive,
...
from RasaWSHH.cli.arguments.default_arguments import add_logging_options
from RasaWSHH.cli.utils import parse_last_positional_argument_as_model_path
from RasaWSHH.utils.common import set_log_level
import RasaWSHH.utils.tensorflow.environment as tf_env
...
def create_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        "your own conversational assistants 🤖. The 'RasaWSHH' command "
...
def main() -> None:
    ...
    if hasattr(cmdline_arguments, "func"):
        RasaWSHH.utils.io.configure_colored_logging(log_level)
