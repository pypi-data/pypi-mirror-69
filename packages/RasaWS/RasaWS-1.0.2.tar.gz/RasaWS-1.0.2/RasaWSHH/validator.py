...
from RasaWSHH.core.domain import Domain
from RasaWSHH.core.training.generator import TrainingDataGenerator
from RasaWSHH.importers.importer import TrainingDataImporter
from RasaWSHH.nlu.training_data import TrainingData
from RasaWSHH.core.training.structures import StoryGraph
from packaging_tutorial.RasaWSHH.core.training.dsl import UserUttered
from packaging_tutorial.RasaWSHH.core.training.dsl import ActionExecuted
from RasaWSHH.core.constants import UTTER_PREFIX
import RasaWSHH.core.training.story_conflict
from RasaWSHH.constants import DOCS_URL_DOMAINS, DOCS_URL_ACTIONS
from RasaWSHH.utils.common import raise_warning
...
class Validator:
    ...
    def verify_story_structure(
        ...
        conflicts = RasaWSHH.core.training.story_conflict.find_story_conflicts(
