...
from RasaWSHH.cli.utils import print_success, create_output_path
...
from RasaWSHH.core.utils import get_dict_hash
from RasaWSHH.exceptions import ModelNotFound
from RasaWSHH.utils.common import TempDirectoryPath
...
async def model_fingerprint(file_importer: "TrainingDataImporter") -> Fingerprint:
    ...
    return {
        ...
        FINGERPRINT_RASA_VERSION_KEY: RasaWSHH.__version__,
    }
...
def fingerprint_from_path(model_path: Text) -> Fingerprint:
    ...
    if os.path.isfile(fingerprint_path):
        return RasaWSHH.utils.io.read_json_file(fingerprint_path)
    else:
        return {}
...
def persist_fingerprint(output_path: Text, fingerprint: Fingerprint):
    ...
    RasaWSHH.utils.io.dump_obj_as_json_to_file(path, fingerprint)
