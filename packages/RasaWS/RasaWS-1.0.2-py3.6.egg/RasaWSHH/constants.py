...
DOCS_URL_MIGRATE_GOOGLE = DOCS_BASE_URL + "/migrate-from/google-dialogflow-to-RasaWSHH/"
...
GLOBAL_USER_CONFIG_PATH = os.path.expanduser("~/.config/RasaWSHH/global.yml")
