...
class ApplicationListenerRule(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationListenerRule"):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, listener: "IApplicationListener", priority: jsii.Number, action: typing.Optional["ListenerAction"]=None, fixed_response: typing.Optional["FixedResponse"]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, redirect_response: typing.Optional["RedirectResponse"]=None, target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param listener: The listener to attach the rule to.
        ...
        """
        props = ApplicationListenerRuleProps(listener=listener, priority=priority, action=action, fixed_response=fixed_response, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, redirect_response=redirect_response, target_groups=target_groups)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.BaseApplicationListenerRuleProps", jsii_struct_bases=[], name_mapping={'priority': 'priority', 'action': 'action', 'fixed_response': 'fixedResponse', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'redirect_response': 'redirectResponse', 'target_groups': 'targetGroups'})
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.AddApplicationActionProps", jsii_struct_bases=[AddRuleProps], name_mapping={'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'priority': 'priority', 'action': 'action'})
class AddApplicationActionProps(AddRuleProps):
    def __init__(self, *, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None, action: "ListenerAction") -> None:
        """Properties for adding a new action to a listener.
...
class ApplicationListener(BaseListener, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationListener"):
    ...
    @jsii.member(jsii_name="addAction")
    def add_action(self, id: str, *, action: "ListenerAction", host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, priority: typing.Optional[jsii.Number]=None) -> None:
        ...
        :param priority: Priority of this target group. The rule with the lowest priority will be used for every request. If priority is not given, these target groups will be added as defaults, and must not have conditions. Priorities must be unique. Default: Target groups are used as defaults
        """
        props = AddApplicationActionProps(action=action, host_header=host_header, path_pattern=path_pattern, path_patterns=path_patterns, priority=priority)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-elasticloadbalancingv2.ApplicationListenerRuleProps", jsii_struct_bases=[BaseApplicationListenerRuleProps], name_mapping={'priority': 'priority', 'action': 'action', 'fixed_response': 'fixedResponse', 'host_header': 'hostHeader', 'path_pattern': 'pathPattern', 'path_patterns': 'pathPatterns', 'redirect_response': 'redirectResponse', 'target_groups': 'targetGroups', 'listener': 'listener'})
class ApplicationListenerRuleProps(BaseApplicationListenerRuleProps):
    def __init__(self, *, priority: jsii.Number, action: typing.Optional["ListenerAction"]=None, fixed_response: typing.Optional["FixedResponse"]=None, host_header: typing.Optional[str]=None, path_pattern: typing.Optional[str]=None, path_patterns: typing.Optional[typing.List[str]]=None, redirect_response: typing.Optional["RedirectResponse"]=None, target_groups: typing.Optional[typing.List["IApplicationTargetGroup"]]=None, listener: "IApplicationListener") -> None:
