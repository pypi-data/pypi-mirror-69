...
from pyrqa.operators.detect_vertical_lines.radius.column_materialisation_byte_recycling import \
...
class ColumnMaterialisationByteRecycling(SettableSettings):
    """
