...
class QWebEngineProfile(PySide2.QtCore.QObject):
    ...
    def clearVisitedLinks(self, urls: typing.Sequence[PySide2.QtCore.QUrl]): ...
    ...
    def setSpellCheckLanguages(self, languages: typing.Sequence[str]): ...
    def setUrlRequestInterceptor(self, interceptor: PySide2.QtWebEngineCore.QWebEngineUrlRequestInterceptor): ...
...
class QWebEngineScriptCollection(Shiboken.Object):
    ...
    @typing.overload
    def insert(self, list: typing.Sequence[PySide2.QtWebEngineWidgets.QWebEngineScript]): ...
