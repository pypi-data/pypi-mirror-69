...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 415,
    ...
    SBK_QSYSINFO_SIZES_IDX                                   = 266,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 264,
    SBK_QSYSINFO_MACVERSION_IDX                              = 265,
    ...
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 317,
    ...
    SBK_QT_CURSORMOVESTYLE_IDX                               = 419,
    ...
    SBK_QTMSGTYPE_IDX                                        = 414,
    SBK_QtCore_IDX_COUNT                                     = 420
};
