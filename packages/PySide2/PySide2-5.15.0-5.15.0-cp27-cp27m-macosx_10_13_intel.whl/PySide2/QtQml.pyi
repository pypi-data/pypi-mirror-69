...
class QQmlApplicationEngine(PySide2.QtQml.QQmlEngine):
    ...
    def setInitialProperties(self, initialProperties: typing.Dict[str, typing.Any]): ...
...
class QQmlComponent(PySide2.QtCore.QObject):
    ...
    def setInitialProperties(self, component: PySide2.QtCore.QObject, properties: typing.Dict[str, typing.Any]): ...
...
class QQmlDebuggingEnabler(Shiboken.Object):
    ...
    @staticmethod
    def setServices(services: typing.Sequence[str]): ...
    @staticmethod
...
class QQmlEngine(PySide2.QtQml.QJSEngine):
    ...
    def setImportPathList(self, paths: typing.Sequence[str]): ...
    ...
    def setPluginPathList(self, paths: typing.Sequence[str]): ...
...
class QQmlFileSelector(PySide2.QtCore.QObject):
    ...
    def setExtraSelectors(self, strings: typing.Sequence[str]): ...
