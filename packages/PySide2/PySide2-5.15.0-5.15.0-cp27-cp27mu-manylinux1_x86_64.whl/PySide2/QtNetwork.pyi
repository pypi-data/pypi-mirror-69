...
class QHostInfo(Shiboken.Object):
    ...
    def setAddresses(self, addresses: typing.Sequence[PySide2.QtNetwork.QHostAddress]): ...
...
class QNetworkCacheMetaData(Shiboken.Object):
    ...
    def setAttributes(self, attributes: typing.Dict[PySide2.QtNetwork.QNetworkRequest.Attribute, typing.Any]): ...
    def setExpirationDate(self, dateTime: PySide2.QtCore.QDateTime): ...
    def setLastModified(self, dateTime: PySide2.QtCore.QDateTime): ...
    def setRawHeaders(self, headers: typing.Sequence[typing.Tuple]): ...
...
class QNetworkCookieJar(PySide2.QtCore.QObject):
    ...
    def setAllCookies(self, cookieList: typing.Sequence[PySide2.QtNetwork.QNetworkCookie]): ...
...
class QNetworkReply(PySide2.QtCore.QIODevice):
    ...
    @typing.overload
    def ignoreSslErrors(self, errors: typing.Sequence[PySide2.QtNetwork.QSslError]): ...
    def ignoreSslErrorsImplementation(self, arg__1: typing.Sequence[PySide2.QtNetwork.QSslError]): ...
    def isFinished(self) -> bool: ...
...
class QSslConfiguration(Shiboken.Object):
    ...
    @typing.overload
    def addCaCertificates(self, certificates: typing.Sequence[PySide2.QtNetwork.QSslCertificate]): ...
    @typing.overload
    ...
    def setAllowedNextProtocols(self, protocols: typing.Sequence[PySide2.QtCore.QByteArray]): ...
    def setBackendConfiguration(self, backendConfiguration: typing.Dict[PySide2.QtCore.QByteArray, typing.Any]=...): ...
    def setBackendConfigurationOption(self, name: PySide2.QtCore.QByteArray, value: typing.Any): ...
    def setCaCertificates(self, certificates: typing.Sequence[PySide2.QtNetwork.QSslCertificate]): ...
    def setCiphers(self, ciphers: typing.Sequence[PySide2.QtNetwork.QSslCipher]): ...
    @staticmethod
    ...
    def setLocalCertificateChain(self, localChain: typing.Sequence[PySide2.QtNetwork.QSslCertificate]): ...
...
class QSslSocket(PySide2.QtNetwork.QTcpSocket):
    ...
    @typing.overload
    @staticmethod
    def addDefaultCaCertificates(certificates: typing.Sequence[PySide2.QtNetwork.QSslCertificate]): ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def setDefaultCaCertificates(certificates: typing.Sequence[PySide2.QtNetwork.QSslCertificate]): ...
    @staticmethod
    def setDefaultCiphers(ciphers: typing.Sequence[PySide2.QtNetwork.QSslCipher]): ...
    @typing.overload
    def setLocalCertificate(self, certificate: PySide2.QtNetwork.QSslCertificate): ...
    @typing.overload
