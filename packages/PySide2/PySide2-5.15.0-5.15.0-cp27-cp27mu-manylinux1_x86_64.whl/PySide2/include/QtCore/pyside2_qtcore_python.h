...
enum : int {
    ...
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 266,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 267,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 268,
    SBK_QTEMPORARYDIR_IDX                                    = 269,
    SBK_QTEMPORARYFILE_IDX                                   = 270,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 271,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 273,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 272,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 112,
    SBK_QTEXTCODEC_IDX                                       = 274,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 275,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 113,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 276,
    SBK_QTEXTDECODER_IDX                                     = 277,
    SBK_QTEXTENCODER_IDX                                     = 278,
    ...
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 290,
    ...
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 316,
...
enum : int {
    ...
    SBK_QTCORE_QLIST_QABSTRACTITEMMODELPTR_IDX               = 26, // QList<QAbstractItemModel* >
