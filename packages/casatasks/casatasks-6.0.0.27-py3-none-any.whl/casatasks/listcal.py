...
##################### 820c6546a313fa4fc7bf83cb03387d2d ##############################
from __future__ import absolute_import
import numpy
from casatools.typecheck import CasaValidator as _val_ctor
_pc = _val_ctor( )
from casatools.coercetype import coerce as _coerce
from .private.task_listcal import listcal as _listcal_t
...
class _listcal:
    ...
    def __call__( self, vis='', caltable='', field='', antenna='', spw='', listfile='', pagerows=int(50) ):
        schema = {'vis': {'type': 'cReqPath', 'coerce': _coerce.expand_path}, 'caltable': {'type': 'cReqPath', 'coerce': _coerce.expand_path}, 'field': {'type': 'cStr'}, 'antenna': {'type': 'cStr'}, 'spw': {'type': 'cStr'}, 'listfile': {'type': 'cStr'}, 'pagerows': {'type': 'cInt'}}
        doc = {'vis': vis, 'caltable': caltable, 'field': field, 'antenna': antenna, 'spw': spw, 'listfile': listfile, 'pagerows': pagerows}
        ...
        return _end_log( _logging_state_, 'listcal', _listcal_t( _pc.document['vis'], _pc.document['caltable'], _pc.document['field'], _pc.document['antenna'], _pc.document['spw'], _pc.document['listfile'], _pc.document['pagerows'] ) )
