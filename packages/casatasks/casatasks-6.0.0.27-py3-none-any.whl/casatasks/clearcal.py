...
class _clearcal:
    ...
    def __call__( self, vis='', field='', spw='', intent='', addmodel=False ):
        schema = {'vis': {'type': 'cReqPath', 'coerce': _coerce.expand_path}, 'field': {'type': 'cStr'}, 'spw': {'type': 'cStr'}, 'intent': {'type': 'cStr'}, 'addmodel': {'type': 'cBool'}}
        ...
        return _end_log( _logging_state_, 'clearcal', _clearcal_t( _pc.document['vis'], _pc.document['field'], _pc.document['spw'], _pc.document['intent'], _pc.document['addmodel'] ) )
