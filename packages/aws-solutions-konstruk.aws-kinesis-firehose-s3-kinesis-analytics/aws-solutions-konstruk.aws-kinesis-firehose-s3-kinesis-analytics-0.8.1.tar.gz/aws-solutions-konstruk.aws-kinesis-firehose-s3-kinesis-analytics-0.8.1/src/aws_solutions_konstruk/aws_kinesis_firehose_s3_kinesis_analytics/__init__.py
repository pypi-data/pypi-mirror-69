...
class KinesisFirehoseToAnalyticsAndS3(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-solutions-konstruk/aws-kinesisfirehose-s3-and-kinesisanalytics.KinesisFirehoseToAnalyticsAndS3"):
    """
    summary:
    ...
    def bucket(self) -> aws_cdk.aws_s3.Bucket:
        """
        return
        :return: Instance of the Bucket created by the construct.
    ...
    def kinesis_analytics(self) -> aws_cdk.aws_kinesisanalytics.CfnApplication:
        """
        return
        :return: Instance of the CfnApplication created by the construct.
