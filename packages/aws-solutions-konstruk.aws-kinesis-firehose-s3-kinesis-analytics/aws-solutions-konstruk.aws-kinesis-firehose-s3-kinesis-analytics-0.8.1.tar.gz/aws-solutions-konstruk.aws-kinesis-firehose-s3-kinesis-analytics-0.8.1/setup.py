...
kwargs = json.loads("""
{
    ...
    "packages": [
        "aws_solutions_konstruk.aws_kinesis_firehose_s3_kinesis_analytics",
        "aws_solutions_konstruk.aws_kinesis_firehose_s3_kinesis_analytics._jsii"
    ],
    "package_data": {
        "aws_solutions_konstruk.aws_kinesis_firehose_s3_kinesis_analytics._jsii": [
            "aws-kinesisfirehose-s3-and-kinesisanalytics@0.8.1.jsii.tgz"
        ],
        "aws_solutions_konstruk.aws_kinesis_firehose_s3_kinesis_analytics": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-konstruk.aws-kinesis-firehose-s3>=0.8.1, <0.9.0",
