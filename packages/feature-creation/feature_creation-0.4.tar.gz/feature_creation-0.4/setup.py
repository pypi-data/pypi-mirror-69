...
# worker-startup log.
CUSTOM_COMMANDS = [['pip', 'install', 'scipy==1.2.1'],
...
setuptools.setup(
    ...
    version='0.4',
    description='Feature Creation Transformer Package.',
    ...
    long_description='Used for Creating Transformers for Load and User Features',
