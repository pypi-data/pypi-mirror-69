...
from dkist_inventory.data.test import rootdir
...
def make_header_files():
    ...
    visp_files = visp.to_fits(
        "sp_5_labelled", path_template=os.path.join(DATA_DIR, "visp_5d_{i:02d}.fits")
    )
    ...
    vtf_files = vtf.to_fits("5d_test", path_template=os.path.join(DATA_DIR, "vtf_5d_{i:02d}.fits"))
