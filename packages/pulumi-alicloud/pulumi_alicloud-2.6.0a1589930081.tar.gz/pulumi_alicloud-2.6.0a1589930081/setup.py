...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.6.0-alpha.1589930081+ge9894a1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.6.0-alpha.1589930081+ge9894a1`
                """)
            else:
                raise
