...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.6.0-alpha.1590083890+gafd51a13'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.6.0-alpha.1590083890+gafd51a13`
                """)
            else:
                raise
