...
def initialize(args):
    ...
    if args.verbose:
        ...
        logging.getLogger('ibm_ai_openscale.utils.client_errors').setLevel(TIMER)
    ...
    if args.mrm and not (args.is_icp and args.ml_engine_type == MLEngineType.WML and args.v4
            and (args.model == 'GermanCreditRiskModel' or args.model == 'NewCreditRiskModel')):
        log_error_raise_exception('ERROR: --mrm only supported in CP4D for WML v4 GermanCreditRiskModel or NewCreditRiskModel')
