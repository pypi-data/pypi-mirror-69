...
class AnalitycsWindow(QMainWindow):
	...
	def __init__(self):
		super().__init__()
		self.createGui()
		self.setImageDirectory(ThisDir(__file__)+"/resources/rededge-mx")		
	...
	def createGui(self):
		...
		self.choose_colormap.addItem(QIcon(os.path.join(ThisDir(__file__),'resources/images','colorbar_brg.png')) , "Colormap 1")
		self.choose_colormap.addItem(QIcon(os.path.join(ThisDir(__file__),'resources/images','colorbar_ryg.png')) , "Colormap 2")
...
def Main():
	...
	QFontDatabase.addApplicationFont(os.path.join(ThisDir(__file__),"resources/fonts","Roboto-Regular.ttf"))
