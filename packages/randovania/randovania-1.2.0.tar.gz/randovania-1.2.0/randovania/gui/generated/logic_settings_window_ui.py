...
class Ui_LogicSettingsWindow(object):
    def setupUi(self, LogicSettingsWindow):
        ...
        LogicSettingsWindow.resize(765, 682)
        ...
        self.tab_widget = QtWidgets.QTabWidget(LogicSettingsWindow)
        ...
        self.trick_level_scroll_contents.setGeometry(QtCore.QRect(0, 0, 725, 534))
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.damage_tab)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.energy_tank_box = QtWidgets.QGroupBox(self.damage_tab)
        self.energy_tank_box.setObjectName("energy_tank_box")
        self.gridLayout = QtWidgets.QGridLayout(self.energy_tank_box)
        ...
        self.gridLayout.addWidget(self.energy_tank_capacity_spin_box, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.energy_tank_capacity_description, 0, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.energy_tank_capacity_label, 2, 0, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.gridLayout.addItem(spacerItem, 1, 1, 1, 1)
        self.verticalLayout_3.addWidget(self.energy_tank_box)
        self.damage_strictness_group = QtWidgets.QGroupBox(self.damage_tab)
        ...
        self.damage_strictness_layout.addItem(spacerItem1)
        ...
        self.dark_aether_box = QtWidgets.QGroupBox(self.damage_tab)
        ...
        self.dark_aether_layout = QtWidgets.QGridLayout(self.dark_aether_box)
        self.dark_aether_layout.setObjectName("dark_aether_layout")
        ...
        self.dark_aether_layout.addWidget(self.dark_suit_spin_box, 3, 1, 1, 1)
        ...
        self.dark_aether_layout.addWidget(self.dark_aether_label, 0, 0, 1, 2)
        spacerItem2 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        self.dark_aether_layout.addItem(spacerItem2, 1, 0, 1, 2)
        self.verticalLayout_3.addWidget(self.dark_aether_box)
        spacerItem3 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem3)
        self.tab_widget.addTab(self.damage_tab, "")
        ...
        self.starting_locations_contents.setGeometry(QtCore.QRect(0, 0, 723, 388))
        ...
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.location_pool_tab)
        ...
        self.verticalLayout_4.addWidget(self.randomization_mode_group)
        ...
        self.excluded_locations_area_contents.setGeometry(QtCore.QRect(0, 0, 699, 316))
        ...
        self.verticalLayout_4.addWidget(self.excluded_locations_group)
        self.tab_widget.addTab(self.location_pool_tab, "")
        ...
        self.translators_scroll_contents.setGeometry(QtCore.QRect(0, 0, 725, 534))
        ...
        self.beam_configuration_tab_layout.addItem(spacerItem4)
        self.tab_widget.addTab(self.beam_configuration_tab, "")
    ...
    def retranslateUi(self, LogicSettingsWindow):
        ...
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.damage_tab), QtWidgets.QApplication.translate("LogicSettingsWindow", "Damage", None, -1))
        ...
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.location_pool_tab), QtWidgets.QApplication.translate("LogicSettingsWindow", "Location Pool", None, -1))
        ...
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.beam_configuration_tab), QtWidgets.QApplication.translate("LogicSettingsWindow", "Beam Configuration", None, -1))
