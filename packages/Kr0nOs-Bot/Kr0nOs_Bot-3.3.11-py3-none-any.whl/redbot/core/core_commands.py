...
class Core(commands.Cog, CoreLogic):
    ...
    async def info(self, ctx: commands.Context):
        ...
        about = _(
            "Let's get toxic af. Kr0nOs is built using Red-Discord's framework,"
            "facing d.py. Join the [support server](https://kable.lol/discord) "
        ...
        embed.add_field(name=_("Kr0nOs version"), value=red_version)
        ...
        embed.add_field(name=_("About Kr0nOs"), value=about, inline=False)

        embed.set_footer(text=_("Kr0nOs Framework by KableKompany#0001").format(days_since))
        try:
    ...
    async def debuginfo(self, ctx: commands.Context):
        ...
        if await ctx.embed_requested():
            ...
            e.add_field(name="Kr0nOs version", value=redver, inline=True)
...
async def license_info_command(ctx):
    """
    Get info about Kr0nOs's licenses
    """
