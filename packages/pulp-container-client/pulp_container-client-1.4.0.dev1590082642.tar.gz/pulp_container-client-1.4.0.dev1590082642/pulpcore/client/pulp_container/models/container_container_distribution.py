...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository_version=None, name=None, repository=None, pulp_href=None, base_path=None, pulp_created=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
