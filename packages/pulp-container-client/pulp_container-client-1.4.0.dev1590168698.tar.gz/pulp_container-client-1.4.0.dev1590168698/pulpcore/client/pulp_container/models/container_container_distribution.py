...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, base_path=None, repository=None, name=None, repository_version=None, content_guard=None, pulp_created=None, pulp_href=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
