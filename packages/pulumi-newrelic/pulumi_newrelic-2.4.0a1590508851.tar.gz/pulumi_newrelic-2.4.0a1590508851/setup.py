...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v2.4.0-alpha.1590508851+g0026dd6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v2.4.0-alpha.1590508851+g0026dd6`
                """)
            else:
                raise
