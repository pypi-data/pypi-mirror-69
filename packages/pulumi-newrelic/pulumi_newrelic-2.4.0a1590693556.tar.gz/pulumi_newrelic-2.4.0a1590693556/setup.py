...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v2.4.0-alpha.1590693556+g0b9dd1f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v2.4.0-alpha.1590693556+g0b9dd1f`
                """)
            else:
                raise
