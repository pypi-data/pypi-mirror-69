...
class VotingKeyLinkTransactionBuilder(TransactionBuilder):
    ...
    def __init__(self, size: int, signature: SignatureDto, signerPublicKey: KeyDto, version: int, network: NetworkTypeDto, type: EntityTypeDto, fee: AmountDto, deadline: TimestampDto, linkedPublicKey: VotingKeyDto, linkAction: LinkActionDto):
        """Constructor.
        Args:
            size: Entity size.
        ...
        self.votingKeyLinkTransactionBody = VotingKeyLinkTransactionBodyBuilder(linkedPublicKey, linkAction)
    ...
    def loadFromBinary(cls, payload: bytes) -> VotingKeyLinkTransactionBuilder:
        ...
        return VotingKeyLinkTransactionBuilder(superObject.size, superObject.signature, superObject.signerPublicKey, superObject.version, superObject.network, superObject.type, superObject.fee, superObject.deadline, votingKeyLinkTransactionBody.linkedPublicKey, votingKeyLinkTransactionBody.linkAction)
