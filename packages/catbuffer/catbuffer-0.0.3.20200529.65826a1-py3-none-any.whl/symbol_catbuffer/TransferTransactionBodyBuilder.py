...
class TransferTransactionBodyBuilder:
    ...
    Attributes:
        ...
        transferTransactionBody_Reserved1: Reserved padding to align mosaics on 8-byte boundary.
    ...
    def serialize(self) -> bytes:
        ...
        bytes_ = GeneratorUtils.concatTypedArrays(bytes_, GeneratorUtils.uintToBuffer(self.getTransferTransactionBody_Reserved1(), 4))  # kind:SIMPLE
        for _ in self.mosaics:
