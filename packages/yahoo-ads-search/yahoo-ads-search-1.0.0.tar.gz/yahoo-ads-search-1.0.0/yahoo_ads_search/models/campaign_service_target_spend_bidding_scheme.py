...
class CampaignServiceTargetSpendBiddingScheme(object):
    ...
    def __init__(self, bid_ceiling=None, local_vars_configuration=None):  # noqa: E501
        """CampaignServiceTargetSpendBiddingScheme - a model defined in OpenAPI"""  # noqa: E501
    ...
    def bid_ceiling(self):
        """Gets the bid_ceiling of this CampaignServiceTargetSpendBiddingScheme.  # noqa: E501
        ...
        :return: The bid_ceiling of this CampaignServiceTargetSpendBiddingScheme.  # noqa: E501
        :rtype: int
        """
    ...
    def bid_ceiling(self, bid_ceiling):
        """Sets the bid_ceiling of this CampaignServiceTargetSpendBiddingScheme.

        <div lang=\"ja\">入札価格の上限です。<br>※「0」が設定された 場合、上限設定は ありません。<br> このフィールドは省略可能となります。その際、デフォルト設定値は0となります。</div> <div lang=\"en\">Bid amount limit.<br>* If &#34;0&#34; is set, no bid limit.<br> This field is optional. The default value will be 0.</div>   # noqa: E501

        :param bid_ceiling: The bid_ceiling of this CampaignServiceTargetSpendBiddingScheme.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignServiceTargetSpendBiddingScheme):
            return False
