...
class CampaignServiceDynamicAdsForSearchSetting(object):
    ...
    def __init__(self, feed_ids=None, local_vars_configuration=None):  # noqa: E501
    ...
    def feed_ids(self):
        ...
        <div lang=\"ja\">キャンペーンで使用するページフィードIDです。<br> ADD時およびSET時、このフィールドは必須となります。</div> <div lang=\"en\">Page Feed ID for campaign.<br> This field is required in ADD and SET operation.</div>   # noqa: E501
