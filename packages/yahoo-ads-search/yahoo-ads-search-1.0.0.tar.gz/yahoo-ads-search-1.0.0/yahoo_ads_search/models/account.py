...
class Account(object):
    ...
    def __init__(self, account_id=None, account_name=None, account_status=None, account_type=None, auth_type=None, auto_tagging_enabled=None, budget=None, delivery_status=None, is_test_account=None, local_vars_configuration=None):  # noqa: E501
