...
from yahoo_ads_search.models.conversion_tracker_service_operation import ConversionTrackerServiceOperation  # noqa: E501
...
class TestConversionTrackerServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_ads_search.models.conversion_tracker_service_operation.ConversionTrackerServiceOperation()  # noqa: E501
        if include_optional :
            return ConversionTrackerServiceOperation(
                account_id = 56,
                operand = [
                    yahoo_ads_search.models.conversion_tracker.ConversionTracker(
                        account_id = 56,
