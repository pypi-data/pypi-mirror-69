...
from yahoo_ads_search.models.report_definition_service_operation import ReportDefinitionServiceOperation  # noqa: E501
...
class TestReportDefinitionServiceOperation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_ads_search.models.report_definition_service_operation.ReportDefinitionServiceOperation()  # noqa: E501
        if include_optional :
            return ReportDefinitionServiceOperation(
                account_id = 56,
                operand = [
                    yahoo_ads_search.models.report_definition.ReportDefinition(
                        account_id = 56,
                        complete_time = '0',
