...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v2.2.0-alpha.1589931316+gc3f5dd6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v2.2.0-alpha.1589931316+gc3f5dd6`
                """)
            else:
                raise
