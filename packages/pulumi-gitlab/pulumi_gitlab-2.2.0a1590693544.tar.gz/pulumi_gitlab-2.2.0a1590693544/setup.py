...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v2.2.0-alpha.1590693544+g2645d9b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v2.2.0-alpha.1590693544+g2645d9b`
                """)
            else:
                raise
