...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v2.2.0-alpha.1590073905+g6fe69dd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v2.2.0-alpha.1590073905+g6fe69dd`
                """)
            else:
                raise
