...
class Scanner():
    def __init__(self, text):
        ...
        self.token = None
        #print("Scanner created, text=", text)
    ...
    def scan(self):
        ...
        if self.index >= self.len:
            ...
            if ch in '.0123456789':
            ...
            elif ch.lower() in '/_abcdefghijklmnopqrstuvwxyz*?-':
                ...
                if text[self.index] != quote:
                    utils.raise_error("Unterminated string at offset=" + str(start) + " in cmd: " + text)
        ...
        #print("scanner.scan returning=", self.token, ", type=", self.token_type)
        return self.token
