...
function GetOciCommandsToLongParams_iam() {
    $ociCommandsToLongParams = @{
        ...
        'iam network-sources list' = 'all compartment-id from-json help limit page page-size'
