...
from simba.plot_heatmap_location import plotHeatMapLocation
import threading
import datetime
...
class loadprojectini:
    def __init__(self,configini):
        ...
        self.hmlvar = IntVar()
        self.hmlvar.set(1)
        button_hmlocation = Button(processmovementdupLabel, text='Create heat maps',
                                   command=lambda: self.run_roiAnalysisSettings(Toplevel(), self.hmlvar,
                                                                                'locationheatmap'))
        # organize
