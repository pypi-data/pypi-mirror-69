...
.. code-block:: python
    ...
    df = pd.DataFrame(data = {'col1': [1, 2],
                              'col2': [3, 4],
                              'col3': [5, 6]})
    gnuplot.plot(df.to_csv(sep = ' '), 'using 1:2 with lines', 'using 1:3 with points')
...
.. code-block:: python
    ...
    pyplot.plot(df.to_csv(sep = ' '), 'using 2:xtic(1), for [i=3:22] "" using i ')
...
1.0.6 The pyplot.plot() now accept the string as the first parameter, you can
