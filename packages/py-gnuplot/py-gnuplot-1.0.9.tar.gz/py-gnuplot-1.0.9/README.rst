...
.. list-table:: Table 3: port of some Matplotlib examples
   :widths: 15, 20, 70
   :header-rows: 1
   ...
   * - Matplotlib script
     ...
     - image
   * - `Stacked bar chart`_
     - matplotlib_port1.py_
     - |sphx_glr_bar_stacked_001.png|
   * - `Grouped bar chart with labels`_
     - matplotlib_port2.py_
...
.. _Stacked bar chart: https://matplotlib.org/_downloads/2ac62a2edbb00a99e8a853b17387ef14/bar_stacked.py
.. _Grouped bar chart with labels: https://matplotlib.org/_downloads/9079c7956239a0c7507bbae7d553ce77/barchart.py
