...
class Configuration(object):
    ...
    def __init__(self, host="http://127.0.0.1:23042",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("gnomock")
        ...
        return [
            {
                ...
                'description': "`gnomock` runs locally in an environment with a configured docker daemon. ",
                'variables': {
                    'port': {
