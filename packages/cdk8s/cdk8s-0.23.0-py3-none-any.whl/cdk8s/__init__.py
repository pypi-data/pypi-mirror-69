...
__jsii_assembly__ = jsii.JSIIAssembly.load("cdk8s", "0.23.0", __name__, "cdk8s@0.23.0.jsii.tgz")
...
class Include(constructs.Construct, metaclass=jsii.JSIIMeta, jsii_type="cdk8s.Include"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: constructs.Construct, name: str, *, url: str) -> None:
        """
        :param scope: -
        :param name: -
...
@jsii.data_type(jsii_type="cdk8s.IncludeOptions", jsii_struct_bases=[], name_mapping={'url': 'url'})
class IncludeOptions():
    ...
    def __repr__(self) -> str:
        return 'IncludeOptions(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
...
class Yaml(metaclass=jsii.JSIIMeta, jsii_type="cdk8s.Yaml"):
    ...
    @builtins.classmethod
    def load(cls, url_or_file: str) -> typing.List[typing.Any]:
    ...
    @builtins.classmethod
    def save(cls, file_path: str, docs: typing.List[typing.Any]) -> None:
    ...
    @builtins.classmethod
    def tmp(cls, docs: typing.List[typing.Any]) -> str:
...
__all__ = ["ApiObject", "ApiObjectMetadata", "ApiObjectOptions", "App", "AppOptions", "Chart", "ChartOptions", "Include", "IncludeOptions", "Testing", "Yaml", "__jsii_assembly__"]
