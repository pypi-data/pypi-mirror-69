...
class LambdaToSns(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-solutions-konstruk/aws-lambda-sns.LambdaToSns"):
    """
    summary:
...
@jsii.data_type(jsii_type="@aws-solutions-konstruk/aws-lambda-sns.LambdaToSnsProps", jsii_struct_bases=[], name_mapping={'deploy_lambda': 'deployLambda', 'enable_encryption': 'enableEncryption', 'encryption_key': 'encryptionKey', 'existing_lambda_obj': 'existingLambdaObj', 'lambda_function_props': 'lambdaFunctionProps', 'topic_props': 'topicProps'})
