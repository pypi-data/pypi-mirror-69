...
__all__ = ("get_desktop_environment", "open_callback", "create_configfactory", "init_logger")
...
def create_configfactory(plugin_paths: iter = (), plugin_files: iter = None) -> confmgr.ConfigFileFactory:
