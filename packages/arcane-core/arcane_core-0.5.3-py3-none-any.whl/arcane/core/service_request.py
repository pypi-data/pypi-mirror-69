...
def call_get_route(url: str, firebase_api_key: str, claims: object, auth_enabled: bool, credentials_path: str=None):
...
def get_client_old(client_id: str, CLIENTS_URL, firebase_api_key, auth_enabled=True, credentials_path: str=None):
    url = f"{CLIENTS_URL}/api/clients/old?client_id={client_id}"
    return call_get_route(url, firebase_api_key, claims={'features_rights': {'clients': 'Viewer'}}, auth_enabled=auth_enabled, credentials_path=credentials_path)


def get_client(client_id: str, CLIENTS_URL, firebase_api_key, auth_enabled=True, credentials_path: str = None):
