...
from emora._flows.family import family
...
# cdf.add_system_transition('root', 'family:start->family:sibling', '', score=3.0)
# cdf.add_system_transition('root', 'family:start->family:siblings', '', score=3.0)
