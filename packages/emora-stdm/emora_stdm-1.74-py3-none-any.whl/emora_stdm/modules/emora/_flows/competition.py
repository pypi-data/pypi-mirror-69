...
competition.knowledge_base().load_json_file(PATHDIR.replace('__***__','_common.json'))
competition.knowledge_base().load_json_file(PATHDIR.replace('__***__','competition.json'))
