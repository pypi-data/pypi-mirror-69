...
relationships = DialogueFlow('_local_start')
relationships.knowledge_base().load_json_file(PATHDIR.replace('__***__', '_common.json'))
relationships.knowledge_base().load_json_file(PATHDIR.replace('__***__', 'relationships.json'))
relationships.add_system_transition('_local_start', 'start', '')

system = {
    'state': 'dating',
    'enter': '#GATE #GCOM(relationship) #GOAL(relationship) #ANY($in_high_school=True,$in_college=True)',
    ...
    '#GSRET(default_relationship)':{
        ...
        '[{#DISAGREE,[not dating],noone,no one,nobody,[!not,{have,got},{a,any},#ONT(partner)]}]':
            'single',
        ...
        '[{complicated,[{hard,challenging,difficult},{explain,describe}]}]': {
            ...
            '`It sounds like your relationship status is complicated. Why is that?`': {
                ...
                'error':{
                    ...
                    '`I see. Well, I hope it clears up soon for you. It is a frustrating situation to feel that way. `': 'exit'
                }
            }
        },
...
marriage = {
    'state': 'marriage',
    'enter': '#GATE #GCOM(relationship) #GOAL(relationship) #ANY($is_student=False,$is_student=None)',
        ...
        '#UNX':{
            ...
            '#GSRET(exit)': {
                ...
                '#DISAGREE':{
                    ...
                    'I hope you still look back on your wedding day fondly too. `': 'exit'
                },
...
user = {
    ...
    #are you married
    '[#NOT(want,wish,hope,desire),{you,your},{married,wedding}]': {
        ...
        '`Well, uh, I mean, there is this really cute boy in my English class. `': {
            ...
            '[name]':{
                ...
                '`Oh, no way! It\'s too real if I tell you that. I cannot believe we are even talking about this. `': {
                    ...
                    '#UNX(None)': {
                        'state': 'crush_name_unx',

                        '`Oh my gosh, I am so flustered thinking about this right now. '
                        'We should really talk about something else. Anyways,` #GRET': 'exit'
                    }
                }
            },
