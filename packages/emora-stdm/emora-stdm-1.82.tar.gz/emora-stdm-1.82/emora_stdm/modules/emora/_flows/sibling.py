...
siblings = {
    'state': 'start',
    'enter': '#GATE #GCOM(sibling) #GOAL(sibling) #IF($life_in=True,$life_started=True)',
...
known_siblings = {
    ...
    '`So, earlier you mentioned your` $sibling=#I($lives_with, #U(brother, sister, brothers, sisters)) ` right? '
