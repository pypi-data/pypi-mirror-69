...
@jsii.data_type(jsii_type="@aws-cdk/core.DefaultStackSynthesizerProps", jsii_struct_bases=[], name_mapping={'asset_publishing_external_id': 'assetPublishingExternalId', 'asset_publishing_role_arn': 'assetPublishingRoleArn', 'cloud_formation_execution_role': 'cloudFormationExecutionRole', 'deploy_role_arn': 'deployRoleArn', 'file_assets_bucket_name': 'fileAssetsBucketName', 'image_assets_repository_name': 'imageAssetsRepositoryName', 'qualifier': 'qualifier'})
class DefaultStackSynthesizerProps():
    def __init__(self, *, asset_publishing_external_id: typing.Optional[str]=None, asset_publishing_role_arn: typing.Optional[str]=None, cloud_formation_execution_role: typing.Optional[str]=None, deploy_role_arn: typing.Optional[str]=None, file_assets_bucket_name: typing.Optional[str]=None, image_assets_repository_name: typing.Optional[str]=None, qualifier: typing.Optional[str]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/core.FileAssetLocation", jsii_struct_bases=[], name_mapping={'bucket_name': 'bucketName', 'http_url': 'httpUrl', 'object_key': 'objectKey', 's3_object_url': 's3ObjectUrl', 's3_url': 's3Url'})
class FileAssetLocation():
    def __init__(self, *, bucket_name: str, http_url: str, object_key: str, s3_object_url: str, s3_url: str) -> None:
...
class DefaultStackSynthesizer(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.DefaultStackSynthesizer"):
    ...
    def __init__(self, *, asset_publishing_external_id: typing.Optional[str]=None, asset_publishing_role_arn: typing.Optional[str]=None, cloud_formation_execution_role: typing.Optional[str]=None, deploy_role_arn: typing.Optional[str]=None, file_assets_bucket_name: typing.Optional[str]=None, image_assets_repository_name: typing.Optional[str]=None, qualifier: typing.Optional[str]=None) -> None:
        ...
        :param qualifier: Qualifier to disambiguate multiple environments in the same account. You can use this and leave the other naming properties empty if you have deployed the bootstrap environment with standard names but only differnet qualifiers. Default: - Value of context key '
        """
        props = DefaultStackSynthesizerProps(asset_publishing_external_id=asset_publishing_external_id, asset_publishing_role_arn=asset_publishing_role_arn, cloud_formation_execution_role=cloud_formation_execution_role, deploy_role_arn=deploy_role_arn, file_assets_bucket_name=file_assets_bucket_name, image_assets_repository_name=image_assets_repository_name, qualifier=qualifier)
