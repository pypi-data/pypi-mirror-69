...
class PlayerMixin:
    ...
    async def change_volume(self, by=0, to=None, backend=None, device=None, fade=False, fade_seconds=5):
        ...
        if isinstance(volume_backend, SpotifyVolumeControlAsync):
            ...
            return await volume_backend.set_volume(volume + by, fade=fade, fade_seconds=fade_seconds)
