...
async def set_default_loadout(client: fortnitepy.Client, config: dict, member: fortnitepy.PartyMember) -> None:
    ...
    party_update_meta = client.party if client.party else client.user.party  # Saves direct route to the party_update_meta object.
    ...
    if party_update_meta.id == client.user.party.id:
