...
class ReClient():
    ...
    def create_dataset_instance(self, dataset_id: str, location: str = None, file_format: str = None):
        '''Creates a new instance of the specified Dataset    '''
    ...
    def create_dataset_instance_from_local_file(self, dataset_id: str, file_format: str = None):
        '''Creates a new instance of the specified Dataset using a local file upload    '''
    ...
    def list_dataset_instances(self, dataset_id: str = None):
        '''Retrieves a list of all of the dataset instances for the specified dataset    '''
    ...
    def get_model_metrics(self, model_id: str = None, model_instance_id: str = None):
        ...
        return self._call_api('getModelMetrics', 'GET', query_params={'modelId': model_id, 'modelInstanceId': model_instance_id}, parse_type=ModelMetrics)

    def list_model_instances(self, model_id: str):
        '''Retrieves a list of all model instances for a given model.    '''
    ...
    def delete_model(self, model_id: str):
        '''Deletes the specified model and all its instances    '''
