...
class ControlService(object):
    ...
    def Propose(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/io.casperlabs.node.api.control.ControlService/Propose',
            control__pb2.ProposeRequest.SerializeToString,
            control__pb2.ProposeResponse.FromString,
