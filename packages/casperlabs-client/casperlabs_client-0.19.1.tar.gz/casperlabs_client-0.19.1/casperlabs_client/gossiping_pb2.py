...
_GETBLOCKCHUNKEDREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='only_include_deploy_hashes', full_name='io.casperlabs.comm.gossiping.GetBlockChunkedRequest.only_include_deploy_hashes', index=4,
