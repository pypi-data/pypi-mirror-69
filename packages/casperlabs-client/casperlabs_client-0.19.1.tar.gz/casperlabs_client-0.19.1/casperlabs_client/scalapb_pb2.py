...
descriptor__pb2.FileOptions.RegisterExtension(options)
message.message_type = _MESSAGEOPTIONS
descriptor__pb2.MessageOptions.RegisterExtension(message)
field.message_type = _FIELDOPTIONS
descriptor__pb2.FieldOptions.RegisterExtension(field)
enum_options.message_type = _ENUMOPTIONS
descriptor__pb2.EnumOptions.RegisterExtension(enum_options)
enum_value.message_type = _ENUMVALUEOPTIONS
descriptor__pb2.EnumValueOptions.RegisterExtension(enum_value)
oneof.message_type = _ONEOFOPTIONS
descriptor__pb2.OneofOptions.RegisterExtension(oneof)
