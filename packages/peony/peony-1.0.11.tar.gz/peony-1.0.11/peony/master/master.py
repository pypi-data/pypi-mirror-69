...
class Master:
    ...
    def __init__(self, app):
        ...
        self.task_queue_manager = TaskQueueManager(
            self.app.worker_id_begin,
            self.app.worker_id_end,
            self.app.task_queue_max_size
        )

    def run(self):
        setproctitle.setproctitle(self.app.make_proc_name(
            'master:%s-%s' % (self.app.worker_id_begin, self.app.worker_id_end)
        ))
    ...
    def _spawn_workers(self):
        ...
        :return:
        """
        for worker_id in range(self.app.worker_id_begin, self.app.worker_id_end + 1):
