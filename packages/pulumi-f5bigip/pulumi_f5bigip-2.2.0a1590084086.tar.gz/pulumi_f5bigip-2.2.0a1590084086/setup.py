...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v2.2.0-alpha.1590084086+gdd8bd1f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v2.2.0-alpha.1590084086+gdd8bd1f`
                """)
            else:
                raise
