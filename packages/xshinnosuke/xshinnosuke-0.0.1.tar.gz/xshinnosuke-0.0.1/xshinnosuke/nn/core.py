...
class Node:
    def __init__(self, in_bounds: List = None, out_bounds: List = None, data=None,
...
class Variable(Node):
    def __init__(self, data: Union[int, float], in_bounds: List = None, out_bounds: Union[List, Tuple] = None,
