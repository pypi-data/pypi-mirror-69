...
def quality_report(analytics, df=None, rep=None):
...
def pdf_from_html(html_file, pdf_file):
    try:
        subprocess.check_output(["wkhtmltopdf -L 0mm -T 0mm -R 0mm -B 0mm {} {}".format(html_file, pdf_file)],
...
def generate_html(analytics, df, rep, all_stats):
    ...
    with doc.tag("html"):
        ...
        with doc.tag("body"):
            ...
            # Only plot correlations if we have a DF
