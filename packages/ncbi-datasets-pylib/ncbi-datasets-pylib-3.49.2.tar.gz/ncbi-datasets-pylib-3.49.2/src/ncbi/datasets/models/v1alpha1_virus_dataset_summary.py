...
class V1alpha1VirusDatasetSummary(object):
    ...
    def __init__(self, assembly_count=None, estimated_file_size_mb=None, released_since=None, resource_updated_on=None, local_vars_configuration=None):  # noqa: E501
