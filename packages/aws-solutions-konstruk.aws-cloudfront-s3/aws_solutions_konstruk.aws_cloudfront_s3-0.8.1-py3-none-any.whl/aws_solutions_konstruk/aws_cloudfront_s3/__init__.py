...
class CloudFrontToS3(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-solutions-konstruk/aws-cloudfront-s3.CloudFrontToS3"):
    ...
    def bucket(self) -> aws_cdk.aws_s3.Bucket:
        """
        return
        :return: Instance of Bucket created by the construct
...
@jsii.data_type(jsii_type="@aws-solutions-konstruk/aws-cloudfront-s3.CloudFrontToS3Props", jsii_struct_bases=[], name_mapping={'bucket_props': 'bucketProps', 'cloud_front_distribution_props': 'cloudFrontDistributionProps', 'deploy_bucket': 'deployBucket', 'existing_bucket_obj': 'existingBucketObj', 'insert_http_security_headers': 'insertHttpSecurityHeaders'})
