...
from django_telethon_multisession.models import TelethonEntity, TelethonSentFile, TelethonSession, TelethonUpdateState
...
class DjangoMultiSession(MemorySession):
