...
class Rotation(Transformation, name="rotate"):
    ...
    def left(self):
        ...
        raise NotImplementedError("Only simple 90° rotations are supported")
    ...
    def back(self):
        ...
        if (self.y == 0 and self.z == 270) or (self.y == 180 and self.z == 90):
            return -self.child.right
        if (self.x == 90 and self.y == 180) or (self.x == 270 and self.z == 0):
            return self.child.bottom
        if (self.x == 90 and self.z == 0) or (self.x == 170 and self.z == 180):
            return -self.child.top
