...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.6.0-alpha.1589925325+gf3411d5f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.6.0-alpha.1589925325+gf3411d5f`
                """)
            else:
                raise
