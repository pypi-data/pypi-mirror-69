...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.6.0-alpha.1590416375+g382d08e7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.6.0-alpha.1590416375+g382d08e7`
                """)
            else:
                raise
