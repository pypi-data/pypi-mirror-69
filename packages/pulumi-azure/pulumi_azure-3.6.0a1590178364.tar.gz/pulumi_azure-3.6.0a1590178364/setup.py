...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.6.0-alpha.1590178364+g32360d2f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.6.0-alpha.1590178364+g32360d2f`
                """)
            else:
                raise
