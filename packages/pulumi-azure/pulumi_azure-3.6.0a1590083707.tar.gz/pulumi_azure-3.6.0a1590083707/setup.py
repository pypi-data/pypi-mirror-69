...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.6.0-alpha.1590083707+g563a0c30'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.6.0-alpha.1590083707+g563a0c30`
                """)
            else:
                raise
