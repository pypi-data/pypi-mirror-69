...
__pypipage__ = requests.get("https://pypi.org/project/hackingtools/")
if __pypipage__.status_code == 200:
    __pageContent = __bs4(__pypipage__.content, 'html.parser'))
    __pypiVersion = __pageContent.find('h1', {'class' : 'package-header__name'}).replace(__tool_name__, '').replace(' ', '')
