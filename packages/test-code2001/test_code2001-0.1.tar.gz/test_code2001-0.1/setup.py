...
setup(
  name = 'test_code2001',         # How you named your package folder (MyLib)
  packages = ['test_code2001'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code2001/archive/v8.0.zip',
