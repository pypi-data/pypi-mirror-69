...
class NscaSender(object):
    def __init__(self, remote_host, config_path='/etc/send_nsca3.cfg', port=DEFAULT_PORT, timeout=10, send_to_all=True):
        """Constructor

        Arguments:
            config_path: path to the nsca config file. Usually /etc/send_nsca3.cfg. None to disable.
