...
class BasicDataPart1(object):
    ...
    def _upload_basic(self, df, table_name, to_truncate=False):
        print(table_name)
        # print(df)
        if to_truncate:
    ...
    def fund_rating_latest(self):
        try:
            ...
            self._upload_basic(df, FundRatingLatest.__table__.name, to_truncate=True)
            return True
        except Exception as e:
            print(e)
            traceback.print_stack()
    ...
    def stock_info(self):
        try:
            ...
            self._upload_basic(df, StockInfo.__table__.name, to_truncate=True)
            return True
        except Exception as e:
            print(e)
            traceback.print_stack()
    ...
    def fund_size(self, start_date, end_date):
        try:
            ...
            df = df[df['fund_id'].notnull()]
            self._upload_basic(df, FundSize.__table__.name, to_truncate=True)
            return True
        except Exception as e:
            print(e)
            traceback.print_stack()
    ...
    def em_index_price(self, start_date, end_date):
        try:
            ...
            BasicDataApi().delete_index_price(index_id_list, start_date, end_date)
