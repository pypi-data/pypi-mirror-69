...
class EmRawDataDownloader(object):
    ...
    def em_stock_post_price(self, start_date: str, end_date: str):
        try:
            ...
            # 更新到db
            self._upload_raw(df, EmStockPostPrice.__table__.name)
            return True
        except Exception as e:
            print(e)
            traceback.print_stack()
    ...
    def download_all(self, start_date, end_date):
        ...
        if not self.em_index_price(['H00140.SH','H11025.CSI'], start_date, end_date):
...
if __name__ == '__main__':
    ...
    # em.em_stock_price('20200518', '20200518')
    # em.em_stock_post_price('20200428', '20200518')
