...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.2.0-alpha.1590074998+gcdfb69f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.2.0-alpha.1590074998+gcdfb69f`
                """)
            else:
                raise
