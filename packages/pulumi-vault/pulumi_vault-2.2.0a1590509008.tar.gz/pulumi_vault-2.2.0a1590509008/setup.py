...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.2.0-alpha.1590509008+g2b28de4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.2.0-alpha.1590509008+g2b28de4`
                """)
            else:
                raise
