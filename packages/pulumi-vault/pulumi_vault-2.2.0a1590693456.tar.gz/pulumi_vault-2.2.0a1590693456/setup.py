...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.2.0-alpha.1590693456+g25a079e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.2.0-alpha.1590693456+g25a079e`
                """)
            else:
                raise
