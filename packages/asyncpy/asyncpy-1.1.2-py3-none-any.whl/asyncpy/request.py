...
class Request(object):
    ...
    if "DEFAULT_REQUEST_CONFIG" not in dir(settings):
        DEFAULT_REQUEST_CONFIG = {}
    else:
        DEFAULT_REQUEST_CONFIG = settings.DEFAULT_REQUEST_CONFIG
    ...
    def __init__(self,
        ...
        # if "USER_AGENT" in dir(setting):
        #     self.headers['User-Agent'] = setting.USER_AGENT


        self.meta = meta or {}
        self.request_session = request_session
        self.request_settings = (
            self.REQUEST_CONFIG if custom_settings is None else custom_settings
        )
