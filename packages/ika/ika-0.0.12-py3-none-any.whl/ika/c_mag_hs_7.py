...
# todo look into north devices runnable mixins for threading utility
...
class CMAGHS7Interface:
    ...
    def start_monitoring_temperature(self):
        warnings.warn('This doesnt do anything yet')
        pass
        # todo get threading to work
        # def monitor_temperature_thread_fn():
        #     while True:
        #         time.sleep(1)
        #         self.register_temperature()
        # if self.monitor_temperature_thread is None:
        #     self.monitor_temperature_thread = ThreadWithStop(target=monitor_temperature_thread_fn).start()

    def stop_monitoring_temperature(self):
        'This doesnt do anything yet'
        pass
        # todo get threading to work
        # if self.monitor_temperature_thread is not None:
        #     self.monitor_temperature_thread.stop()
        #     del self.monitor_temperature_thread
        #     self.monitor_temperature_thread = None
    ...
    def wait_until_temperature_stable(self,
        ...
        # self.stop_monitoring_temperature()
        start_time: str = self.datetime_manager.now_string()
        start_time: datetime = datetimeManager.str_to_datetime(start_time,
                                                               datetime_format=self.datetime_format)[0]
        while True:
            ...
            if seconds_passed > time_out:
                # self.start_monitoring_temperature()
                return False
            else:
                time.sleep(1)
                self.register_temperature()
