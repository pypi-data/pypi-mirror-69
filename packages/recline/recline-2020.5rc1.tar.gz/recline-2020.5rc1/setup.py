...
setup_kwargs = {
    'name': 'recline',
    'version': '2020.5rc1',
    'description': 'Writing argparse-based command line applications can become tedious, repetitive, and clich\xc3\xa9d.  This library helps you quickly implement an interactive command-based application in Python',
