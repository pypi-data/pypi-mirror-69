...
setup(
  name = 'test_code2005',         # How you named your package folder (MyLib)
  packages = ['test_code2005'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code2005/archive/v12.0.zip',
