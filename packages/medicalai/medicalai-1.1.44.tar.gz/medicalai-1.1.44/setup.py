...
setup(name='medicalai',
      ...
      download_url = 'https://github.com/aibharata/medicalAI/archive/v'+about['__version__']+'.tar.gz',
      keywords = ['AI Framework', 'Medical AI', 'Tensorflow', 'radiology AI'],
      author=about['__author__'],
      author_email='contact@aibharata.com',
      license=about['__license__'],
	  install_requires=['pandas','tensorflow','tf_explain','numpy', 'pillow','tqdm', 'matplotlib', 'plotly', 'pandas', 'seaborn', 'sklearn', 'pydicom'],
