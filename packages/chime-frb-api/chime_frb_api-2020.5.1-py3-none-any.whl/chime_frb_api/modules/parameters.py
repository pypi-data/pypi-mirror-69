...
class Parameters(object):
    ...
    def get_max_size(self, datapath: str = None, fileformat: str = None) -> int:
        """
    ...
    def get_filenames(self, event_number: int = None) -> list:
        """
        ...
        """
        return self.API.get("/v1/events/filenames/{}".format(event_number))
