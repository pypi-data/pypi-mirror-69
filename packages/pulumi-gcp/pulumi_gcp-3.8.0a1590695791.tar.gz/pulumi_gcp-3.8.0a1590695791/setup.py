...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.8.0-alpha.1590695791+ga8da54d2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.8.0-alpha.1590695791+ga8da54d2`
                """)
            else:
                raise
