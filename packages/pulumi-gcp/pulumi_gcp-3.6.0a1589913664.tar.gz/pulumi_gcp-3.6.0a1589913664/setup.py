...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.6.0-alpha.1589913664+g7c3e3651'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.6.0-alpha.1589913664+g7c3e3651`
                """)
            else:
                raise
