...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.7.0-alpha.1590508626+gf130bf20'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.7.0-alpha.1590508626+gf130bf20`
                """)
            else:
                raise
