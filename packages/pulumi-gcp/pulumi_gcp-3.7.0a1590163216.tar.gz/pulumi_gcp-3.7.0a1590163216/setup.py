...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.7.0-alpha.1590163216+g8bd3f006'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.7.0-alpha.1590163216+g8bd3f006`
                """)
            else:
                raise
