...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.7.0-alpha.1590415808+g2fca23e3'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.7.0-alpha.1590415808+g2fca23e3`
                """)
            else:
                raise
