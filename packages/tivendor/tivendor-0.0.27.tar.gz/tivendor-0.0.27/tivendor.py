...
class TiVendor:
    ...
    def kafka_expush(self, info, response, start_time, end_time, service_name, ti_request_headers, **kwargs):
        self.logger.error('kafka_expush ===================1')
        if self.kafka_producer:
            self.logger.error('kafka_expush ===================2')
            url = info['url']
            method = info['method']
            ...
            self.logger.error('kafka_expush ===================3')
            start_new_thread(kafka_push, args=(), kwargs=kwargs)
            self.logger.error('kafka_expush ===================4')
...
def kafka_push(**kwargs):
    ...
    instance.logger.error('kafka_push ===================1')
    ...
    instance.logger.error('kafka_push ===================2')
    ...
    instance.logger.error('kafka_push ===================3')
