...
kwargs = json.loads("""
{
    "name": "aws-solutions-konstruk.aws-apigateway-dynamodb",
    "version": "0.8.1",
    ...
    "packages": [
        "aws_solutions_konstruk.aws_apigateway_dynamodb",
        "aws_solutions_konstruk.aws_apigateway_dynamodb._jsii"
    ],
    "package_data": {
        "aws_solutions_konstruk.aws_apigateway_dynamodb._jsii": [
            "aws-apigateway-dynamodb@0.8.1.jsii.tgz"
        ],
        "aws_solutions_konstruk.aws_apigateway_dynamodb": [
            "py.typed"
        ]
