...
setup(
  name = 'test_code2003',         # How you named your package folder (MyLib)
  packages = ['test_code2003'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code2003/archive/v10.0.zip',
