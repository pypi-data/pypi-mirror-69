...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        binomial_coefficient = ((math.factorial(self.n) / math.factorial(self.n - k)) / math.factorial(k))
    ...
    def plot_histogram_pdf(self):
        ...
        plt.hist(y)
        plt.title('Normed Histogram of Data')
        plt.xlabel(f'k from 0 to {self.n}')
        plt.ylabel('Density')
    ...
    def __add__(self, other):
        ...
        sum = Binomial(self.p, self.n + other.n)
