...
def Pathes_view_Update(request):
    return JsonResponse(DSResponseUpdate(data=Pathes.objects.updateFromRequest(request,propsArr=['enable_upload']), status=RPCResponseConstant.statusSuccess).response)
