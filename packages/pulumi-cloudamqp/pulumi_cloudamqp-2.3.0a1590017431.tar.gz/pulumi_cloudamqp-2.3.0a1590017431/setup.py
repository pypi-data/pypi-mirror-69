...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v2.3.0-alpha.1590017431+g218399c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v2.3.0-alpha.1590017431+g218399c`
                """)
            else:
                raise
