...
from argus_api.exceptions.http import (
    ArgusException, AuthenticationFailedException, AccessDeniedException,
    ObjectNotFoundException, ValidationErrorException
)
...
def validate_http_response(resp):
    ...
    try:
        ...
        msg = "The provided object is not a requests.Response-like object:\n" \
              f"Object: {resp}"
