...
def add_document_by_path_raw(
    ...
    url = "{}/documents/v1/document/path{parentFolderPath}/{documentName}".format(settings["api"]["api_url"], accessMode=accessMode, parentFolderPath=parentFolderPath, documentName=documentName, customer=customer, createMissing=createMissing)
    headers = {
