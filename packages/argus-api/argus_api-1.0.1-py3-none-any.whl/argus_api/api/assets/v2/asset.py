...
def add_asset(
    ...
    :param bool forceIndex: Whether to force an Elasticsearch index such that the new Asset is immediately searchable. 
    ...
    if forceIndex is not None:
        body.update({ "forceIndex": forceIndex })
...
def search_assets(
    ...
    parent: str = None,
    ancestor: str = None,
    assetComponentSearchRequest: dict = None,
    ...
    :param list assetComponentSearchRequest: Search for Assets by their components using AND search mode i.e. all criteria must match.<br />If you want different behaviour try using subcriteria 
    :param list criticalitySearchRequest: Search for Assets by Confidentiality, Availability, and Integrity. 
    ...
    # Only send assetComponentSearchRequest if the argument was provided, dont send null values
    if assetComponentSearchRequest is not None:
        body.update({ "assetComponentSearchRequest": assetComponentSearchRequest })
