...
from datarobot_cmrunner.cmrunner.description import version
from datarobot_cmrunner.cmrunner.common import LOG_LEVELS, ArgumentsOptions, RunLanguage
    ...
    def _reg_arg_docker(*parsers):
        for parser in parsers:
            ...
            parser.add_argument(
                ...
                default=None,
                required=False,
                help="Docker image to use to run {} in the {} mode".format(ArgumentsOptions.MAIN_COMMAND, prog_name_lst[1]),
            )
