...
setup(
  ...
  url = 'https://github.com/user/Animenosekai/lifeeasy',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/Animenosekai/lifeeasy/archive/v1.0.tar.gz',    # Archive link
