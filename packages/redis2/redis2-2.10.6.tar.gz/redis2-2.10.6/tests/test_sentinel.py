...
from redis2.sentinel import (Sentinel, SentinelConnectionPool,
                             MasterNotFoundError, SlaveNotFoundError)
from redis2._compat import next
import redis2.sentinel
...
def cluster(request):
    def teardown():
        redis2.sentinel.StrictRedis = saved_StrictRedis
    cluster = SentinelTestCluster()
    saved_StrictRedis = redis2.sentinel.StrictRedis
    redis2.sentinel.StrictRedis = cluster.client
