...
import redis2
from redis2._compat import b, u, unichr, unicode
...
class TestPipeline(object):
    ...
    def test_pipeline_no_transaction_watch_failure(self, r):
        ...
        with r.pipeline(transaction=False) as pipe:
            ...
            with pytest.raises(redis2.WatchError):
                pipe.execute()
    ...
    def test_exec_error_in_response(self, r):
        ...
        with r.pipeline() as pipe:
            ...
            assert isinstance(result[2], redis2.ResponseError)
            assert r['c'] == b('a')
    ...
    def test_exec_error_raised(self, r):
        ...
        with r.pipeline() as pipe:
            pipe.set('a', 1).set('b', 2).lpush('c', 3).set('d', 4)
            with pytest.raises(redis2.ResponseError) as ex:
                pipe.execute()
