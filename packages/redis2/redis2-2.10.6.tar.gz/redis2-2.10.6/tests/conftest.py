...
def r(request, **kwargs):
    return _get_client(redis2.Redis, request, **kwargs)


@pytest.fixture()
def sr(request, **kwargs):
    return _get_client(redis2.StrictRedis, request, **kwargs)
...
def mock_cluster_resp_ok(request, **kwargs):
    r = _get_client(redis2.Redis, request, **kwargs)
