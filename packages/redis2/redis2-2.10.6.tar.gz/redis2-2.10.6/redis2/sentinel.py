...
from redis2.client import StrictRedis
from redis2.connection import ConnectionPool, Connection
from redis2.exceptions import (ConnectionError, ResponseError, ReadOnlyError,
                               TimeoutError)
from redis2._compat import iteritems, nativestr, xrange
