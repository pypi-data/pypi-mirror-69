...
# %%
constant_current = step_current


# %%
def shock_current(p_points, p_duration, p_size, duration, dt):
...
if __name__ == '__main__':
    ...
    import sys
    sys.path.append('../../')
    from npbrain.utils.visualization import get_figure
