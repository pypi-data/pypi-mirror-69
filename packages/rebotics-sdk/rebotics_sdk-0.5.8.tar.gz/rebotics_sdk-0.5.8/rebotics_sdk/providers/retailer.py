...
class RetailerProvider(ReboticsBaseProvider):
    ...
    def notify_processing_upload_finished(self, id_):
    ...
    def get_product_info_by_upc(self, upc_list):
    ...
    def v1_upload_preview(self, product_id, image_id):
        return self.session.post(
            product_id=product_id,
            json={
                'image': image_id
    ...
    def get_spacial_data(self, scan_id):
    ...
    def export_to_dataset(self, scan_ids, batch_size=5):
