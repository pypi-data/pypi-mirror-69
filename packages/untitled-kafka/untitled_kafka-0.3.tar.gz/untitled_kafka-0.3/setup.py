...
setup(
    name='untitled_kafka',  # How you named your package folder (MyLib)
    packages=['untitled-kafka', 'untitled-kafka.common.utils', 'untitled-kafka.consumer', 'untitled-kafka.producer'],
