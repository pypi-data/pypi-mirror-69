...
setup(
    name='untitled-kafka',  # How you named your package folder (MyLib)
    packages=['untitled-kafka', 'untitled-kafka.common', 'untitled-kafka.consumer', 'untitled-kafka.producer'],
