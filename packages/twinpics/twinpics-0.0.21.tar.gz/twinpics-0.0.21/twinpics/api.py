...
def NLP_analysis(data, keyword_corpus, hashtag_corpus):
	...
	tweets_df = sm.sentiental_analysis_features(tweets_df)
	sample_data_tokenized = sm.tokenize_tweets(tweets_df)
	tweets_df = sm.keyword_score(tweets_df, sample_data_tokenized,keyword_corpus)
	tweets_df = sm.hashtag_score(tweets_df, sample_data_tokenized,hashtag_corpus)	
