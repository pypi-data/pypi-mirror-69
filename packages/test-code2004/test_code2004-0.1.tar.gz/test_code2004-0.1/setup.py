...
setup(
  name = 'test_code2004',         # How you named your package folder (MyLib)
  packages = ['test_code2004'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code2004/archive/v11.0.zip',
