...
class Plotter(ABC):
    ...
    def __init__(self, output_path="./plot.pdf", save_tfile=False,
    ...
    def save(self):
        output_tfile = ROOT.TFile(os.path.basename(self._output_path) + ".root")
        output_tfile.cd()
        self._canvas.Write('canvas', ROOT.kOverwrite)
        output_tfile.Write()
        output_tfile.Close()
