...
class BsdSpill(VirtualSpill):
    def __init__(self):
        self.bsd_spill_number = _NON_INITIALIZED_VALUE
        self.converted_spill_number = _NON_INITIALIZED_VALUE
        self.pot = float(_NON_INITIALIZED_VALUE)
        self.timestamp = float(_NON_INITIALIZED_VALUE)
        self.bsd_good_spill_flag = _NON_INITIALIZED_VALUE


class WagasciSpill(VirtualSpill):
    def __init__(self):
        self.spill_count = _NON_INITIALIZED_VALUE
        self.spill_number = _NON_INITIALIZED_VALUE
        self.converted_spill_number = _NON_INITIALIZED_VALUE
        self.spill_mode = _NON_INITIALIZED_VALUE
        self.good_spill_flag = _NON_INITIALIZED_VALUE
...
class WagasciBsdSpill(VirtualSpill):
    def __init__(self):
        self.spill_count = _NON_INITIALIZED_VALUE
        self.spill_number = _NON_INITIALIZED_VALUE
        self.fixed_spill_number = _NON_INITIALIZED_VALUE
        self.converted_spill_number = _NON_INITIALIZED_VALUE
        self.spill_mode = _NON_INITIALIZED_VALUE
        self.good_spill_flag = _NON_INITIALIZED_VALUE
        self.bsd_spill_number = _NON_INITIALIZED_VALUE
