...
class WagasciAnalysis(object):
    ...
    @wagascianpy.utils.utils.utf8_decorator
    def spill_number_fixer(self, input_dir, output_dir, output_filename, flipped_bits,
                           offset, enable_graphics, fix_zed_board_bug):
        ...
        wg_snf = _wrap_function(lib_snf, 'wgSpillNumberFixer', ct.c_int,
                                [ct.c_char_p, ct.c_char_p, ct.c_char_p, ct.c_char_p,
                                 ct.c_int, ct.c_bool, ct.c_bool])
        return wg_snf(input_dir, output_dir, output_filename, flipped_bits,
                      offset, enable_graphics, fix_zed_board_bug)
