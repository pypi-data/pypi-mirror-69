...
with open("scrapy_warc/__init__.py", "r") as f:
    for line in f:
...
kwargs = {
    ...
    "author": "Stefan Voshage",
    "author_email": "s.voshage@datenmarkt.de",
    "maintainer": "Stefan Voshage",
    "maintainer_email": "s.voshage@datenmarkt.de",
    "url": "https://github.com/_/scrapy-warc",
