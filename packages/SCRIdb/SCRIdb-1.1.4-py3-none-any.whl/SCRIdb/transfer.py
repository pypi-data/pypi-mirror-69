...
def df_compiler(d: list, m: str = "all", dist: str = "") -> list:
    ...
    :param d:
        Sample ids
    :param m:
        Mode of operation, one of `all`, or `hashtags`
    :param dist:
    ...
    statements = []
    for i in d:
        statements.append(statement[m].format(dist, i))
...
def data_transfer(
    ...
    :param mode:
        Choose between `all` or `hashtags`
    ...
    for i in df.itertuples():
        try:
            ...
            assert i.Run_Name not in ["H2", "H3", "H4"]
            ...
            if i.status == "analyzed":
                ...
                statement1 = (
                    ...
                    "sampleData_id={}".format(i.table, os.path.join(i.dest, ""), i.id,)
                )
            statement2 = ""
