    ...
    def get_rubrics(self) -> dict:
        ...
        if assignments:
            for assignment in assignments:
                if assignment.get("id") == self.assignment_id:
                    return assignment
...
class GS_Question:
    ...
    def is_grouping_ready(self):
        if self.question_id is None:
            return
        data = self.assignment_grader.client.grouping_get_answer_groups(self.assignment_grader.course_id, self.question_id)
