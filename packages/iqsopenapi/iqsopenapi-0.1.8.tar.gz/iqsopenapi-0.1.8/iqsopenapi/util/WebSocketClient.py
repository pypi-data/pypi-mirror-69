...
class WebSocketClient(object):
    ...
    def __ReceiveMsg(self):
        ...
        while True:
            try:
                ...
                logger.error(self.config.address + 'receive msg exception',e)
                time.sleep(1)
    ...
    def __HandleMsg(self):
        ...
        while True:
            try:
                ...
                logger.error(self.config.address + 'handle msg exception',e)
                time.sleep(1)
    ...
    def __AutoHeartBeat(self):
        ...
        while True:
            ...
            try:
                ...
                logger.error(self.config.address + 'heart beat exception',e)
                self.__Close()
    ...
    def __Close(self):
        try:
            ...
            logger.error(self.config.address +'close connect excetpion',e)
