...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v2.2.0-alpha.1590508925+g5a0d0ba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v2.2.0-alpha.1590508925+g5a0d0ba`
                """)
            else:
                raise
