...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v2.2.0-alpha.1589930161+g9ef2e98'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v2.2.0-alpha.1589930161+g9ef2e98`
                """)
            else:
                raise
