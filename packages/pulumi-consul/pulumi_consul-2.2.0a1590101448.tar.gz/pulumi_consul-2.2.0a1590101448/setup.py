...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v2.2.0-alpha.1590101448+gcd275e8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v2.2.0-alpha.1590101448+gcd275e8`
                """)
            else:
                raise
