            ...
            def go(char):
                ...
                def _(event):
                    ...
                    if True:#not '"' in after_line and not "'" in after_line:
                        ...
                        #                  '\\fo':'for ',#go f
                        #                  '\\el':'el'}#go e
                        header_arg_commands={'\\ed':'editor','\\re':'replace','\\py':'python','\\dtl':'delete to line','\\go':'goto','\\al':'align_lines','\\ac':'align_char','\\sw':'strip_whitespace','\\sc':'strip_comments','\\mla':'multi line arguments','\\lo':'load','\\sa':'save','\\wr':'write','\\ca':'cancel'}
