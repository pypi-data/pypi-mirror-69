...
MICROCOMPLETIONS:
	...
	BACKSLASH COMMANDS:
		...
		WITHOUT ARGUMENTS:
			...
			\ed  editor                  (opens up the current buffer in vim. Edit your code, then save the temp file and close vim.)
			...
			\223 python 2 to 3           (converts python2 code to python3 code)
