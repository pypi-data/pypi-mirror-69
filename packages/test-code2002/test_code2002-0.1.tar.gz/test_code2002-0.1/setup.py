...
setup(
  name = 'test_code2002',         # How you named your package folder (MyLib)
  packages = ['test_code2002'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code2002/archive/v9.0.zip',
