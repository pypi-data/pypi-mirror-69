...
from yahoo_ads_display.models.stats_service_get_response import StatsServiceGetResponse  # noqa: E501
from yahoo_ads_display.rest import ApiException

class TestStatsServiceGetResponse(unittest.TestCase):
    """StatsServiceGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = yahoo_ads_display.models.stats_service_get_response.StatsServiceGetResponse()  # noqa: E501
        if include_optional :
            return StatsServiceGetResponse(
                ...
                rid = '0',
                rval = yahoo_ads_display.models.stats_service_page.StatsServicePage(
                    period = yahoo_ads_display.models.stats_service_period.StatsServicePeriod(
                    ...
                    values = [
                        yahoo_ads_display.models.stats_service_value.StatsServiceValue(
                            account_id = 56,
                            ad_group_stats_value = yahoo_ads_display.models.stats_service_ad_group_stats_value.StatsServiceAdGroupStatsValue(
                                campaign_id = 56,
                                campaign_name = '0',
                                ad_group_id = 56,
                                ad_group_name = '0',
                            ...
                            ad_stats_value = yahoo_ads_display.models.stats_service_ad_stats_value.StatsServiceAdStatsValue(
                                campaign_id = 56,
                                campaign_name = '0',
                                ad_group_id = 56,
                                ad_group_name = '0',
                                ad_id = 56,
                                ad_name = '0', ),
                            campaign_stats_value = yahoo_ads_display.models.stats_service_campaign_stats_value.StatsServiceCampaignStatsValue(
                                campaign_id = 56,
                                campaign_name = '0', ),
                            errors = [
                                yahoo_ads_display.models.error.Error(
                            ...
                            image_stats_value = yahoo_ads_display.models.stats_service_image_stats_value.StatsServiceImageStatsValue(
                                media_id = 56,
                                media_name = '0',
                                media_title = '0', ),
                            ...
                            target_stats_value = yahoo_ads_display.models.stats_service_target_stats_value.StatsServiceTargetStatsValue(
                                campaign_id = 56,
                                campaign_name = '0',
                                ad_group_id = 56,
                                ad_group_name = '0',
                            ...
                            type = 'CAMPAIGN',
                            video_stats_value = yahoo_ads_display.models.stats_service_video_stats_value.StatsServiceVideoStatsValue(
                                media_id = 56,
                                video_name = '0',
                                video_title = '0', ), )
                        ], )
    ...
    def testStatsServiceGetResponse(self):
        """Test StatsServiceGetResponse"""
