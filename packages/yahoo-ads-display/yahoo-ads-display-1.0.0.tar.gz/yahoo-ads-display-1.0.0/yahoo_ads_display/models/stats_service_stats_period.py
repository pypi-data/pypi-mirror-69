...
class StatsServiceStatsPeriod(object):
    ...
    allowable_values = [REALTIME_TODAY, DEFINITE_VALUE_YESTERDAY, DEFINITE_VALUE_LASTWEEK, DEFINITE_VALUE_LASTBSDAY, DEFINITE_VALUE_WEEK, DEFINITE_VALUE_TWOWEEK, DEFINITE_VALUE_THIRTYDAY, REALTIME_MONTH, DEFINITE_VALUE_LASTMONTH, DEFINITE_VALUE_LAST13MONTH, CUSTOM_DATE, UNKNOWN]  # noqa: E501
