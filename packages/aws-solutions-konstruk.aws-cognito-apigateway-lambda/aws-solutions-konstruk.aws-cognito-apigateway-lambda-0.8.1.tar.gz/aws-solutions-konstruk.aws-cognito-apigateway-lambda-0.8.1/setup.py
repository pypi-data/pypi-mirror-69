...
kwargs = json.loads("""
{
    ...
    "packages": [
        "aws_solutions_konstruk.aws_cognito_apigateway_lambda",
        "aws_solutions_konstruk.aws_cognito_apigateway_lambda._jsii"
    ],
    "package_data": {
        "aws_solutions_konstruk.aws_cognito_apigateway_lambda._jsii": [
            "aws-cognito-apigateway-lambda@0.8.1.jsii.tgz"
        ],
        "aws_solutions_konstruk.aws_cognito_apigateway_lambda": [
            "py.typed"
        ]
