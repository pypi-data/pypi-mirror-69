"""Controllability module for CLI.

  Typical usage example:

  controllability_command = ControllabilityCommand()
  controllability_command.run()
"""
import time
...
class ControllabilityCommand(BaseCommand):
    """Initialise controllability command.

    Example:
        nwa controllability -f <json_file>
    """

    def __init__(self):
        super(ControllabilityCommand, self).__init__()
        self.name = "controllability"
    ...
    def analyse(self, file: str = "", output: str = "") -> None:
        """Calls the controllability analysis with the provided graph data.
