...
class BaseModel(object):
    ...
    def __init__(self,
        ...
        # 高阶部分
        self.dense_output_layer = list(fc_utils.get_dense_out(self.fc2input, dense_dim=self.dense_dim,
                                                         dense_activation=dense_activation))
        self.embedding_output_layer = list(fc_utils.get_embedding_out(self.fc2input, embedding_dim='auto'))
