...
try:
    ...
    # JPG file profile uses pillow which requires shared libraries
    # this can be problematic for example in case of building cross platform
    # Flywhee CLI binary
    # make this module optional to allow using migration-toolkit in python
    # packages that don't require JPG file profile
    pass
