...
class ApiGatewayToLambda(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-solutions-konstruk/aws-apigateway-lambda.ApiGatewayToLambda"):
    """
    summary:
    ...
    def rest_api(self) -> aws_cdk.aws_apigateway.LambdaRestApi:
        """
        return
        :return: Instance of LambdaRestApi created by the construct
...
@jsii.data_type(jsii_type="@aws-solutions-konstruk/aws-apigateway-lambda.ApiGatewayToLambdaProps", jsii_struct_bases=[], name_mapping={'deploy_lambda': 'deployLambda', 'api_gateway_props': 'apiGatewayProps', 'existing_lambda_obj': 'existingLambdaObj', 'lambda_function_props': 'lambdaFunctionProps'})
