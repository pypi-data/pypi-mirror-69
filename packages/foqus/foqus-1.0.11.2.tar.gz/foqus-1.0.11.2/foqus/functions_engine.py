...
def delete_project(customer, customer_type, api_project, project_name, project_id):
    ...
    if project_name != "" and api_project == "similars":
        ...
        vectors_path_azure = AZURE_VECTORS_PATH + customer_type + '/' + customer + '/' + project_name
        output_path_azure = AZURE_OUTPUT_PATH + customer_type + '/' + customer + '/images/' + project_name
        input_path_azure = AZURE_INPUT_PATH + customer_type + '/' + customer + '/images/' + project_name
        streams_path_azure = AZURE_STREAMS_PATH + customer_type + '/' + customer + '/similars/' + \
                             project_name
        training_path_azure = AZURE_TRAINING_PATH + customer_type + '/' + customer + '/classification/' + \
                              project_name
        try:
            if os.path.isdir(input_path_project_to_delete):
                if USE_AWS:
                    ...
                    for file in list_repository_files(input_path_azure):
                        copy_azure_file(file, AZURE_CONTAINER_NAME, "deleted-" + AZURE_CONTAINER_NAME)
            ...
            if os.path.isdir(output_path_project_to_delete):
                if USE_AWS:
                    ...
                    for file in list_repository_files(output_path_azure):
                        copy_azure_file(file, AZURE_CONTAINER_NAME, "deleted-" + AZURE_CONTAINER_NAME)
            ...
            if os.path.isdir(vectors_path_project_to_delete):
                if USE_AWS:
                    ...
                    for file in list_repository_files(vectors_path_azure):
                        copy_azure_file(file, AZURE_CONTAINER_NAME, "deleted-" + AZURE_CONTAINER_NAME)
            ...
            if os.path.isdir(streams_path_project_similars_to_delete):
                if USE_AWS:
                    ...
                    for file in list_repository_files(streams_path_azure):
                        copy_azure_file(file, AZURE_CONTAINER_NAME, "deleted-" + AZURE_CONTAINER_NAME)
            ...
            if os.path.isdir(training_path_project_to_delete):
                if USE_AWS:
                    ...
                    for file in list_repository_files(training_path_azure):
                        copy_azure_file(file, AZURE_CONTAINER_NAME, "deleted-" + AZURE_CONTAINER_NAME)
