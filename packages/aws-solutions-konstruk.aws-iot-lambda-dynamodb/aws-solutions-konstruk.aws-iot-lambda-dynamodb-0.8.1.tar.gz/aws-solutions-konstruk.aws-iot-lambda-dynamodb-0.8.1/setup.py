...
kwargs = json.loads("""
{
    ...
    "packages": [
        "aws_solutions_konstruk.aws_iot_lambda_dynamodb",
        "aws_solutions_konstruk.aws_iot_lambda_dynamodb._jsii"
    ],
    "package_data": {
        "aws_solutions_konstruk.aws_iot_lambda_dynamodb._jsii": [
            "aws-iot-lambda-dynamodb@0.8.1.jsii.tgz"
        ],
        "aws_solutions_konstruk.aws_iot_lambda_dynamodb": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-konstruk.aws-iot-lambda>=0.8.1, <0.9.0",
        "aws-solutions-konstruk.aws-lambda-dynamodb>=0.8.1, <0.9.0",
