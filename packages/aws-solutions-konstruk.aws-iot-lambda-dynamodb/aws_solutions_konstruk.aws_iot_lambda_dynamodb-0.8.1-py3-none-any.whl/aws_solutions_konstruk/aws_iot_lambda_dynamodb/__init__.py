...
class IotToLambdaToDynamoDB(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-solutions-konstruk/aws-iot-lambda-dynamodb.IotToLambdaToDynamoDB"):
