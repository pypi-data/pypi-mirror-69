...
class HashDict(dict):
    def __init__(self,*args,**kwargs):
        r = dict(*args,**kwargs)
        dict.__init__(self,[(HashWrap(k),v) for k,v in r.items()])
...
class HashDefaultDict(defaultdict):
    def __init__(self,default_factory=None, *args,**kwargs):
        ...
        defaultdict.__init__(self, default_factory,[(HashWrap(k),v) for k,v in r.items()])
    def __getitem__(self, k):
...
class HashOrderedDict(OrderedDict):
    def __init__(self,*args,**kwargs):
        ...
        OrderedDict.__init__(self, [(HashWrap(k),v) for k,v in r.items()])
    def __getitem__(self, k):
    ...
    def keys(self):
        ...
        return ret
    def items(self):
        for k,v in OrderedDict.items(self):
            yield k.arg, v
    def __iter__(self):
