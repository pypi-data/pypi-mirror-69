...
setup(
  ...
  version = '0.2.2.1',
  license='MIT',
  description = 'A single wrapper to handle all of your stock data and trading needs',
  author = 'Jaden Shiteng Wang',
  author_email = 'jaden.shiteng.wang@gmail.com',
  url = 'https://github.com/JadenSWang/Stock-Wrapper',
  download_url = 'https://github.com/JadenSWang/Stock-Wrapper/archive/2.2.1.tar.gz',
