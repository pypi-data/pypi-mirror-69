...
freq_res = read.read_post_proc(input_file)[4]
kinput = read.read_post_proc(input_file)[5::][0]
labels = read.read_post_proc(input_file)[6]
modes = read.read_post_proc(input_file)[7]
temperatures_folders = read.read_post_proc(input_file)[8]
