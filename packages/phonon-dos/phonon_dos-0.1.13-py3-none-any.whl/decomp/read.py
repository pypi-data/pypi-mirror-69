...
def read_post_proc(input_file):
    ...
    modes = np.fromstring(lista[8], dtype=np.int, sep=',')
    
    temperature_folders = lista[9]
    
    return plot_types, n_atom_unit_cell, file_eigenvectors, max_Z, freq_res, kpoints, labels, modes, temperature_folders
