...
def train(trainer, model, reader):
    ...
    dump_object_to_file(predictor, Path(r"akkadian/output/predictor"))
    dump_object_to_file(model, Path(r"akkadian/output/model"))
...
def check_results(train_texts, dev_texts, test_texts, sign_to_id, id_to_tran):
    ...
    :return: nothing
    """
    predictor_from_file = load_object_from_file(Path(r"akkadian/output/predictor"))
    model_from_file = load_object_from_file(Path(r"akkadian/output/model"))
