...
user_guidance_map = {
    ...
    "unreachable, the mqtt-router service is not responding, or that the automator is not responding. Open the RAE web UI on the target "
    "RAE and make sure the Automator module is running, and that this computer can ping the target broker.",
