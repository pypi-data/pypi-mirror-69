...
class Estimator:
    def __init__(self, ctx:Context, psfInst, calib=None):
        ...
        self.colnames = [s.strip() for s in self.fmt.split(',')]
    ...
    def _checkparams(self, params, constants, roipos):
        ...
        if constants is None:
            ...
            if not np.array_equal(constants.shape, [numspots, self.numconst]):
    ...
    def _CRLBAndChiSquare(self, params, samples=None,roipos=None, constants=None):
        params,constants,roipos=self._checkparams(params,constants,roipos)
    ...
    def ChiSquare(self, params, samples, roipos=None, constants=None):
        return self._CRLBAndChiSquare(params, samples, roipos, constants)[1]
    ...
    def Estimate(self, imgs, roipos=None, constants=None, initial=None):
        ...
        if initial is not None:
            ...
            assert np.array_equal(initial.shape, [numspots, self.numparams])
