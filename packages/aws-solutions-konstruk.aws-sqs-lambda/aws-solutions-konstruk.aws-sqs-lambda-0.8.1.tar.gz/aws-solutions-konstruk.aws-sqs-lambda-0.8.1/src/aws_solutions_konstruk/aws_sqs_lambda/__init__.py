...
class SqsToLambda(aws_cdk.core.Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-solutions-konstruk/aws-sqs-lambda.SqsToLambda"):
    """
    summary:
    :summary:: The SqsToLambda class.
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, deploy_lambda: bool, deploy_dead_letter_queue: typing.Optional[bool]=None, encryption_key_props: typing.Any=None, existing_lambda_obj: typing.Optional[aws_cdk.aws_lambda.Function]=None, lambda_function_props: typing.Any=None, max_receive_count: typing.Optional[jsii.Number]=None, queue_props: typing.Any=None) -> None:
        """
        ...
        :param encryption_key_props: Optional user provided props to override the default props for the KMS. Default: - Default props are used
        ...
        :param max_receive_count: The number of times a message can be unsuccesfully dequeued before being moved to the dead-letter queue. Default: - required field if deployDeadLetterQueue=true.
        ...
        """
        props = SqsToLambdaProps(deploy_lambda=deploy_lambda, deploy_dead_letter_queue=deploy_dead_letter_queue, encryption_key_props=encryption_key_props, existing_lambda_obj=existing_lambda_obj, lambda_function_props=lambda_function_props, max_receive_count=max_receive_count, queue_props=queue_props)
...
@jsii.data_type(jsii_type="@aws-solutions-konstruk/aws-sqs-lambda.SqsToLambdaProps", jsii_struct_bases=[], name_mapping={'deploy_lambda': 'deployLambda', 'deploy_dead_letter_queue': 'deployDeadLetterQueue', 'encryption_key_props': 'encryptionKeyProps', 'existing_lambda_obj': 'existingLambdaObj', 'lambda_function_props': 'lambdaFunctionProps', 'max_receive_count': 'maxReceiveCount', 'queue_props': 'queueProps'})
class SqsToLambdaProps():
    def __init__(self, *, deploy_lambda: bool, deploy_dead_letter_queue: typing.Optional[bool]=None, encryption_key_props: typing.Any=None, existing_lambda_obj: typing.Optional[aws_cdk.aws_lambda.Function]=None, lambda_function_props: typing.Any=None, max_receive_count: typing.Optional[jsii.Number]=None, queue_props: typing.Any=None) -> None:
        """
        :param deploy_lambda: Whether to create a new Lambda function or use an existing Lambda function. If set to false, you must provide an existing function for the ``existingLambdaObj`` property. Default: - true
        :param deploy_dead_letter_queue: Whether to deploy a secondary queue to be used as a dead letter queue. Default: - true.
        :param encryption_key_props: Optional user provided props to override the default props for the KMS. Default: - Default props are used
