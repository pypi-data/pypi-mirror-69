...
def _should_set_reset_index(automl_run: Optional[Run] = None,
    ...
    if automl_run is not None:
        if constants.SupportedModels.Forecasting.AutoArima in automl_run.properties.get('run_algorithm'):
            return True
        elif automl_run.tags.get('ensembled_algorithms') is not None:
            return constants.SupportedModels.Forecasting.AutoArima in automl_run.tags.get('ensembled_algorithms')
