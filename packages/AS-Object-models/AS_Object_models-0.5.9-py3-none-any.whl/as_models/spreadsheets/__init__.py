...
class DownloadItemData(object):
    ...
    'Lead_Time_For_Sample','Pack_Size','Tray','Double_Spike_Percent',
    'customer_item_description','customer_case_number',
    'Ti','Hi','Case_Width','Case_Quantity','Cases_Per_Pallet',
    'Case_UPC','Case_Weight_lbs','Case_Height','Ethyl_Block','Box',
    'CO_Case_Num', 'Special_Instructions_Recipe','Date_Code','Pot_Size_ML',
    'Branches', 'POP','Pick','UPC_Location','Availability','Vase_Style',
    'Sleeve','Top_Dressing','Heat_Pack','Is_Available_For_Samples',
    'Date_Code_Type','Grade','Assortment','Tag_Type','Staging','Case_Length',
    'Insert','Simple_Wick','Pot_Size_Oz','List_Price_FOB_CO','List_Price',
