...
def historify(X: np.ndarray, history_len: int, num_histories: int = None, offset: int = 0):
    ...
    Returns:
        np.ndarray: 3D array organized as (num_histories, history_len,
        feature_dim)
    """
    num_histories = (
    ...
    )[:num_histories].reshape(num_histories, -1)
