...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        plt.title('Bar Chart of the Distribution')
        plt.xlabel('outcome')
        plt.ylabel('count')
        plt.show()
    ...
    def pdf(self, k):
        ...
        """
        comb = math.factorial(self.n)/(math.factorial(self.n-k)*math.factorial(k))
    ...
    def plot_bar_pdf(self):
        ...
        y = [self.pdf(i) for i in range(0,self.n+1)]
        plt.bar(x,y)
        plt.title("Bar graph for Probability Density Function")
        plt.xlabel("Outcome")
