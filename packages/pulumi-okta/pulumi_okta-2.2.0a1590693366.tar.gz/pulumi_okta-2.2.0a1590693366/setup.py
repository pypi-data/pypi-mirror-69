...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v2.2.0-alpha.1590693366+g36c65a6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v2.2.0-alpha.1590693366+g36c65a6`
                """)
            else:
                raise
