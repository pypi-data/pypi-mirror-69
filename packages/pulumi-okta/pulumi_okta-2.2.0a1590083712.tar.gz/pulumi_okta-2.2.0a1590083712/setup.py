...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v2.2.0-alpha.1590083712+g3cb8df2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v2.2.0-alpha.1590083712+g3cb8df2`
                """)
            else:
                raise
