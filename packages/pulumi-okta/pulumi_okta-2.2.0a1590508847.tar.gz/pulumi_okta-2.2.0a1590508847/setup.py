...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v2.2.0-alpha.1590508847+g1ad27ae'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v2.2.0-alpha.1590508847+g1ad27ae`
                """)
            else:
                raise
