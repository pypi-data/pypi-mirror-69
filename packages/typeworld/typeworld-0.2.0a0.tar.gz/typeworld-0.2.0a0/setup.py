...
setup(
  ...
  version = '0.2.0-alpha',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/typeworld/typeworld/archive/v0.2.0-alpha.tar.gz',    # I explain this later on
  ...
  entry_points={
    'console_scripts': [
      "validateTypeWorldEndpoint = typeworld.tools.validate:main",
    ]
  },
  package_dir={'': 'Lib'},
