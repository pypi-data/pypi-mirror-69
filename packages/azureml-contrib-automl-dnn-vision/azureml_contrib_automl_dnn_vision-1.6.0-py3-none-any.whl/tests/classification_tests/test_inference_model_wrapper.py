...
class TestInferenceModelWrapper:
    def test_inference_cpu(self, image_dir):
        with tempfile.TemporaryDirectory() as tmp_output_dir:
            ...
            _write_model(inference_model_wrapper.model_wrapper, labels=classes, output_dir=tmp_output_dir)
            model_wrapper_pkl = os.path.join(tmp_output_dir, ArtifactsLiterals.MODEL_WRAPPER_PKL)
