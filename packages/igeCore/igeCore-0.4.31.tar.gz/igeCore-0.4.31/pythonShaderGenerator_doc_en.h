...
//setReceiveShadow
PyDoc_STRVAR(setReceiveShadow_doc,
	"Enable / disable receive shadow\n"\
	"\n"\
	"shaderGenerater.setReceiveShadow(enable)\n"\
	"\n"\
	"Parameters\n"\
	"----------\n"\
	"    enable : bool\n");
...
//setMakeShadow
PyDoc_STRVAR(setMakeShadow_doc,
	"Enable / disable make shadow\n"\
	"\n"\
	"shaderGenerater.setMakeShadow(enable)\n"\
	"\n"\
	"Parameters\n"\
	"----------\n"\
	"    enable : bool\n");
...
//setLightViewProj
PyDoc_STRVAR(setLightViewProj_doc,
	"Enable / disable use LightViewProj\n"\
	"\n"\
	"shaderGenerater.setLightViewProj(enable)\n"\
	"\n"\
	"Parameters\n"\
	"----------\n"\
	"    enable : bool\n");
