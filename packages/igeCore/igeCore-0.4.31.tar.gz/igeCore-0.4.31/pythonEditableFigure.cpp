...
namespace pyxie
{
	...
	static PyObject* editablefigure_getJointName(editablefigure_obj* self, PyObject* args)
	{
		int index;
		if (!PyArg_ParseTuple(args, "i", &index)) return NULL;
		const char* name = self->editablefigure->GetJointName(index);
		if (!name) {
			Py_INCREF(Py_None);
			return Py_None;
		}
	...
	static PyObject* editablefigure_getMeshName(editablefigure_obj* self, PyObject* args)
	{
		int index;
		if (!PyArg_ParseTuple(args, "i", &index)) return NULL;
		const char* name = self->editablefigure->GetMeshName(index);
		if (!name) {
			Py_INCREF(Py_None);
			return Py_None;
		}
	...
	static PyObject* editablefigure_getMaterialName(editablefigure_obj* self, PyObject* args)
	{
		int index;
		if (!PyArg_ParseTuple(args, "i", &index)) return NULL;
		const char* name = self->editablefigure->GetMaterialName(index);
		if (!name) {
			Py_INCREF(Py_None);
			return Py_None;
		}
	...
	{ "getJointName",(PyCFunction)editablefigure_getJointName,METH_VARARGS,getJointName_doc},
	{ "getMeshName",(PyCFunction)editablefigure_getMeshName,METH_VARARGS,getMeshName_doc},
	{ "getMaterialName",(PyCFunction)editablefigure_getMaterialName,METH_VARARGS,getMaterialName_doc},
