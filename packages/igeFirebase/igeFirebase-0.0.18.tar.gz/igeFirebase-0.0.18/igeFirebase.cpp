...
{
	static char* kwlist[] = { "analytics","messaging","remoteConfig","firestore",NULL };
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwargs, "|iiii", kwlist, &analytics, &messaging, &remoteConfig, &firestore)) return NULL;
