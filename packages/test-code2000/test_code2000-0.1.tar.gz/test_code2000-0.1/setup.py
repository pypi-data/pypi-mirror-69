...
setup(
  name = 'test_code2000',         # How you named your package folder (MyLib)
  packages = ['test_code2000'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/arunnbaba/test_code2000/archive/v7.0.zip',
