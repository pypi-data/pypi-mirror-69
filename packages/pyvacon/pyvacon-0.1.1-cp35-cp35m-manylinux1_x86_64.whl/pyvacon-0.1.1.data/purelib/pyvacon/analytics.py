...
class InflationIndexForwardCurve(DatedCurve):
    ...
    def value(self, *args):
        ...
        :param date:: The date for which the inflation index will be calculated. :type inflationInterp: string
...
class MarketDataManager(object):
    ...
    def getDiscountCurve(self, issuer, cur, secLvl):
        return _analytics.MarketDataManager_getDiscountCurve(self, issuer, cur, secLvl)
...
class CouponDescription(object):
    ...
    def __init__(self, *args):
        ...
        :param anualizedFixedCoupon:: The annualized fixed coupon. :type fixingDate: :py:class:`ptime`
        :param fixingDate:: The fixing date of a coupondetermined by a floating rate. :type floatingPeriodStart: :py:class:`ptime`
        :param floatingPeriodStart:: The floating rate's period end. :type floatingPeriodEnd: :py:class:`ptime`
        :param floatingPeriodEnd:: The floating rate's period end. :type floatingSpread: float
        :param floatingSpread:: Additive spread on floating rate. :type floatingRateCap: float
        :param floatingRateCap:: Cap of the foatig rate. If not specified, no cap is applied. :type floatingRateFloor: float
        :param floatingRateFloor:: Floor of floating rate. :type floatingFixingUdl: string
...
class PricingResults(object):
    ...
    def getSpot(self, key):
        return _analytics.PricingResults_getSpot(self, key)
...
class VolatilityCalibrator(object):
    ...
    @staticmethod
    def computeImpliedVols(result, valDate, fwd, dsc, pdeParam, americanAsEuropeanVols):
        return _analytics.VolatilityCalibrator_computeImpliedVols(result, valDate, fwd, dsc, pdeParam, americanAsEuropeanVols)
...
def VolatilityCalibrator_computeImpliedVols(result, valDate, fwd, dsc, pdeParam, americanAsEuropeanVols):
    return _analytics.VolatilityCalibrator_computeImpliedVols(result, valDate, fwd, dsc, pdeParam, americanAsEuropeanVols)
...
class ComboPricingData(BasePricingData):
    ...
    def __init__(self, _spec, _pricingData):
        _analytics.ComboPricingData_swiginit(self, _analytics.new_ComboPricingData(_spec, _pricingData))
...
class CalibrationCalibratorMapping(BaseObject):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, calibrationType, _calibratorType):
        _analytics.CalibrationCalibratorMapping_swiginit(self, _analytics.new_CalibrationCalibratorMapping(calibrationType, _calibratorType))

    def getClassName(self):
        return _analytics.CalibrationCalibratorMapping_getClassName(self)
    __swig_destroy__ = _analytics.delete_CalibrationCalibratorMapping

# Register CalibrationCalibratorMapping in _analytics:
_analytics.CalibrationCalibratorMapping_swigregister(CalibrationCalibratorMapping)

class BaseCalibrationData(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
...
class BaseCalibrator(object):
    ...
    @staticmethod
    def calibrate(calibStore, calDate, mktData, paramStore, calibrationRequest, specManager):
        return _analytics.BaseCalibrator_calibrate(calibStore, calDate, mktData, paramStore, calibrationRequest, specManager)
...
def BaseCalibrator_calibrate(calibStore, calDate, mktData, paramStore, calibrationRequest, specManager):
    return _analytics.BaseCalibrator_calibrate(calibStore, calDate, mktData, paramStore, calibrationRequest, specManager)
...
class TransitionMatrixCalibrationData(BaseCalibrationData):
    ...
    def __init__(self):
        _analytics.TransitionMatrixCalibrationData_swiginit(self, _analytics.new_TransitionMatrixCalibrationData())
