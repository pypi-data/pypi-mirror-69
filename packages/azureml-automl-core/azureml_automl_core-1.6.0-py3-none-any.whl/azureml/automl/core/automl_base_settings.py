...
class AutoMLBaseSettings:
    ...
    def _init_logging(self, debug_log: str) -> None:
        """

        :return:
        """
        log_server.set_log_file(debug_log)
        use_telemetry, verbosity = get_diagnostics_collection_info()
        if use_telemetry and self._instrumentation_key:
