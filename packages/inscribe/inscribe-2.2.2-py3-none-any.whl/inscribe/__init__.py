...
class Client(object):
    def __init__(self, api_key: str, user_id: str, version: int = None,
                 host: str = CONFIG['url']):
    ...
    def upload_document(self, customer_id: str, document: object, verify_name: str = None, verify_address: str = None):
