...
class ExternalClassWrapper:
    ...
    def reload(self):
        ...
        for owned_module in self.owned_module_keys:
            if owned_module in sys.modules:
                importlib.reload(sys.modules[owned_module])
        # Why loop through this twice? Because the modules would need to be loaded from bottom-up
