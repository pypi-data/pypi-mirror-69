...
from .tables import glob, load_table, SCHEMA_VERSION, DATASET_TABLES
...
class Captures:
    ...
    1lKPm06z09uX9gZIbmBUMO6WKlIGXiv3hgXb_taPOnU0/edit#heading=h.ya72jmn8a5uz
    Examples:
        ...
        >>> data = captures.filter(def_id=
        "6716c783-1c0e-44ae-b1b5-7f068454b66e")
    ...
    def filter(self, def_id):
        ...
        ego (dict)  \
        {'ego_id': '44ca9...', 'translation': [0.0, 0.0, -20.0], 'rotation':
        [0.0, 0.0, 0.0, 1.0], 'velocity': None, 'acceleration': None}

        filename(str)        format(str)    annotation.id (str) \
        RGB3/asd.png         PNG            ace0
