...
from .data.datasets.cityscapes import CITYSCAPES_COLOR_MAPPING
...
def grid_plot(images, figsize=(3, 5), img_type="rgb"):
...
def plot_bboxes(image, boxes, colors=None, box_line_width=1, font_scale=50):
    ...
    for i, box in enumerate(boxes):
        ...
        font_file = str(PARENT_DIR / "font" / "arial.ttf")
