...
from datasetinsights.data.transforms import Resize, RandomHorizontalFlip
from datasetinsights.evaluation_metrics import EvaluationMetric
from datasetinsights.visual import grid_plot
...
class UpSample(nn.Sequential):
    ...
    def forward(self, x, concat_with):
        ...
        return self.leakyreluB(self.convB(self.leakyreluA(
...
class DenseDepth(Estimator):
    ...
    def _evaluate_one_epoch(self, loader, epoch, n_epochs):
        ...
        a1_metric = EvaluationMetric.create(
            "ThresholdAccuracy", threshold=1.25
        )
