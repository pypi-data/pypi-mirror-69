...
from datasetinsights.data.simulation import Captures, AnnotationDefinitions
...
def _download_captures(root, manifest_file):
    ...
    #todo add link to synthetic dataset schema
    Args:
...
def read_bounding_box_2d(annotation, label_mappings):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if run_execution_id:
            ...
            download_manifest(
                run_execution_id, manifest_file, auth_token,
