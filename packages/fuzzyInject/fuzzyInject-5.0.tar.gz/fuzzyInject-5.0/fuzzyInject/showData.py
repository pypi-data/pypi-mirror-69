...
if __name__ == "__main__":
   ...
   url = "http://jiuji-sonar.yxapp.in/api/measures/search_history?component=" + str(project_name) +  "&metrics=sqale_index%2Cduplicated_lines_density%2Cncloc%2Ccoverage%2Cbugs%2Ccode_smells%2Cvulnerabilities&ps=1000"
   print (url)
   ...
   send_mail_html(['zhiqiangma3@CREDITEASE.CN','xuetingzhao@CREDITEASE.CN','hongchen50@CREDITEASE.CN','yingjunliu2@creditease.cn'],'root@test.com',email_subject,html,project_name,job_url)
