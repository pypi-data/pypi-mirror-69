...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_solutions_konstruk.aws_dynamodb_stream_lambda_elasticsearch_kibana._jsii": [
            "aws-dynamodb-stream-lambda-elasticsearch-kibana@0.8.1.jsii.tgz"
        ],
        "aws_solutions_konstruk.aws_dynamodb_stream_lambda_elasticsearch_kibana": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-solutions-konstruk.aws-dynamodb-stream-lambda>=0.8.1, <0.9.0",
        "aws-solutions-konstruk.aws-lambda-elasticsearch-kibana>=0.8.1, <0.9.0",
