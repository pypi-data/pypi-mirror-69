...
class CogniteGeospatialClient:
    ...
    def get_spatial_info_async(self, id: int = None, external_id: str = None):
        ...
        try:
            response = yield self.api.by_ids_spatial_items(self.project, spatial_by_ids)
    ...
    def delete_spatial_async(self, id: int = None, external_id: str = None):
        ...
        try:
            response = yield self.api.delete_spatial(self.project, spatial_delete_ids)
            return _first_item(response)
        except ApiException as e:
            _throw_exception(e)
    ...
    def get_spatial_async(self, id: int = None, external_id: str = None):
        ...
        spatial_item = yield self.get_spatial_info_async(id=id, external_id=external_id, project=self.project)
        ...
        try:
            response = yield self.api.get_spatial_items_data_names(self.project, item)
            if response is not None:

                for data_item in response.items:
                    data_request = SpatialDataRequestDTO(spatial_id=item, name=data_item.name)
                    data = yield self.api.get_spatial_items_data(self.project, data_request)
    ...
    def get_coverage_async(self, id: int = None, external_id: str = None, projection: str = None):
        ...
        try:
            response = yield self.api.get_spatial_coverage(self.project, spatialite_projection)
            return _first_item(response)
        except ApiException as e:
            _throw_exception(e)
    ...
    def find_spatial_async(
        ...
        try:
            response = yield self.api.search_spatial(self.project, spatial_search_request_dto=spatial_search_request)
            if response is not None:
