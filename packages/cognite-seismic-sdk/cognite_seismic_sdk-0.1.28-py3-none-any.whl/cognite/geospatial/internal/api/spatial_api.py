...
class SpatialApi(object):
    ...
    def add_spatial_item_data_with_http_info(self, project, spatial_data_dto, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            "spatial_data_dto" not in local_var_params or local_var_params["spatial_data_dto"] is None  # noqa: E501
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `spatial_data_dto` when calling `add_spatial_item_data`"
            )  # noqa: E501
    ...
    def get_spatial_items_data_names_with_http_info(self, project, either_id_dto, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params["kwargs"]):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_spatial_items_data_names" % key
                )
            local_var_params[key] = val
        del local_var_params["kwargs"]
        # verify the required parameter 'project' is set
        if self.api_client.client_side_validation and (
            ...
            raise ApiValueError(
                "Missing the required parameter `project` when calling `get_spatial_items_data_names`"
            )  # noqa: E501
        # verify the required parameter 'either_id_dto' is set
        if self.api_client.client_side_validation and (
            "either_id_dto" not in local_var_params or local_var_params["either_id_dto"] is None  # noqa: E501
        ):  # noqa: E501
            raise ApiValueError(
                "Missing the required parameter `either_id_dto` when calling `get_spatial_items_data_names`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/api/playground/projects/{project}/spatial/data/names",
            "POST",
            path_params,
            query_params,
            header_params,
