...
class Makecmd(object):
    ...
    def __init__(self):
        ...
        listcmds    Lists files converted by makecmd
    ...
    def convert(self):
        ...
        os.system(f"cp {FILE} {self.exec_directory}")
        os.system(
            f"mv {self.exec_directory}/{FILE} {self.exec_directory}/{new_filename}")
        os.system(f"chmod +x {self.exec_directory}/{new_filename}")
